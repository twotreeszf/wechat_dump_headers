...
- (void)onBlockMonitorReportMainThreadCheckNumbers:(int)arg1;
- (void)onBlockMonitorDiskIOReportRepeat;
- (void)onBlockMonitorDiskIOReportReadSize:(unsigned long long)arg1 andWriteSize:(unsigned long long)arg2;
- (void)onBlockMonitorDiskIOReportReadDump:(_Bool)arg1 writeDump:(_Bool)arg2;
