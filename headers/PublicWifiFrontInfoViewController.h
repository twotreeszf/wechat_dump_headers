...
@class APBase, CLLocationManager, MMScrollView, MMUIActivityIndicatorView, MMWebImageView, NSString, RichTextView, UIButton, UIImageView, UILabel, UIView, WCAccountBindPhoneControlLogic, WCBizLoadingView;
