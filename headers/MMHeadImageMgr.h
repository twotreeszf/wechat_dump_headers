...
@interface MMHeadImageMgr : MMUserService <HeadImgDelegate, IContactMgrExt, IStrangerContactMgrExt, IStrangerBrandContactHeadImageExt, WAContactMgrExtension, INewSyncExt, MMServiceProtocol>
{
