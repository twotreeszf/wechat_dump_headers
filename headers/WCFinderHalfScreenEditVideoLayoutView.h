...
@class NSMutableArray, NSString, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIView, WCFinderAlbumScrollViewParamModel, WCFinderEditVideoCropView, WCFinderEditVideoMultiVideoCropView, WCFinderEditVideoPorgressInfoViewModel, WCFinderEditVideoProgressInfoView, WCFinderHalfScreenEditFrameBlurView;
@protocol WCFinderHalfScreenEditVideoLayoutViewDelegate;

@interface WCFinderHalfScreenEditVideoLayoutView : WCEditVideoLayoutView <WCFinderEditVideoProgressInfoViewDelegate, WCFinderEditVideoCropViewDelegate, WCEditImageOperationDelegate, WCFinderHalfScreenEditFrameBlurViewDelegate, WCFinderEditVideoMultiVideoCropViewDelegate>
{
    _Bool _enableCropVideoSize;
    _Bool _isTimeCropDragging;
    _Bool _lastCropViewHeight;
    id <WCFinderHalfScreenEditVideoLayoutViewDelegate> _finderDelegate;
...
@property(nonatomic) __weak id <WCFinderHalfScreenEditVideoLayoutViewDelegate> finderDelegate; // @synthesize finderDelegate=_finderDelegate;
- (id)getMusicLogoName;
