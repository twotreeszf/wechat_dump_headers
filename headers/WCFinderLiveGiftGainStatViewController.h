...
@interface WCFinderLiveGiftGainStatViewController : MMUIViewController <MMLiveRewardGainRecordCellDelegate, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource, MMRefreshTableFooterDelegate>
{
