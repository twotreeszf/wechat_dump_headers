...
+ (void)initialize;
+ (void)PBArrayAdd_appLaunchScheme;
+ (void)PBArrayAdd_appNotShowNew;
+ (void)PBArrayAdd_appInfoFlag;
+ (void)PBArrayAdd_appIntroViewUrl;
+ (void)PBArrayAdd_appRcmIconUrl;
+ (void)PBArrayAdd_appNameTW;
+ (void)PBArrayAdd_appNameEn;
+ (void)PBArrayAdd_appCoverUrl;
+ (void)PBArrayAdd_appDownloadUrl;
+ (void)PBArrayAdd_appSnapShotUrl;
+ (void)PBArrayAdd_appSnsDesc;
+ (void)PBArrayAdd_appDesc;
