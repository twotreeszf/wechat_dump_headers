...
@interface WCSessionFlowConfiger : NSObject <IExptServiceExt>
{
    ...
    NSMutableArray *_gestureMonitorBlackList;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *gestureMonitorBlackList; // @synthesize gestureMonitorBlackList=_gestureMonitorBlackList;
