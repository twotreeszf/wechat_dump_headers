...
@interface WCFinderFeedRecommendVM : NSObject <WCFinderDataItemExt, WCFinderPostingCommentExt, WCFinderRedDotNotifyExt, WCFinderFeedContentVMExt, WCFinderLiveExt>
{
