...
+ (void)navigateToTopicSearchResultFromComment:(id)arg1 ofDataItem:(id)arg2 query:(id)arg3;
+ (void)navigateToTopicSearchResultFromFeed:(id)arg1 query:(id)arg2;
+ (_Bool)navigateToTextDetailViewController:(id)arg1 andDataItemTid:(id)arg2 isAdComment:(_Bool)arg3 currentViewController:(id)arg4;
