...
@class JITRuntime, NSMutableArray, NSMutableDictionary, NSString;
...
- (id)processInvokeHandler:(id)arg1 param:(id)arg2 callbackId:(unsigned int)arg3;
- (void)onTerminate;
- (void)onLoad:(id)arg1;
