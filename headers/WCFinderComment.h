...
@class FinderContactMsgInfo, NSArray, NSData, NSNumber, NSString;
...
+ (void)__wcdb_table_constraint_30:(struct WCTBinding *)arg1;
+ (void)__wcdb_table_constraint_29:(struct WCTBinding *)arg1;
