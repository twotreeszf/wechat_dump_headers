...
@class NSMutableArray, NSString, QMUClusterManager, UIImageView, WABaseView;
@protocol WAMapViewDelegate;

@interface WAMapView : QMapView <QMapViewDelegate, WAClusterViewDelegate, WAMapAnnotationViewDelegate, QMapViewIndoorDelegate>
{
