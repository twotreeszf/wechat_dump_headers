...
- (void)configureAudioMixParameters:(id)arg1 withVolumn:(float)arg2 inTimeRange:(CDStruct_e83c9415)arg3;
- (void)configureAudioMixParameters:(id)arg1 WithVolumnProcessNode:(id)arg2;
