...
@class ConfAVMemberList, IConfSDKRegisterableCallbackHolder, MMConfSDKAudioMgr, MMConfSDKCGIImp, MMConfSDKMemberMgr, MMConfSDKNativeCallbackMgr, MMConfSDKNetworkMgr, MMConfSDKVideoHWenc, MMConfSDKVideoMgr, MMTimer, NSMutableArray, NSMutableDictionary, NSObject, NSString;
@protocol MultitalkApiDelegate, OS_dispatch_queue;

@interface MMConfSDKService : MMUserService <MMConfSDKVideoHWencDelegate, MMServiceProtocol>
{
    NSObject<OS_dispatch_queue> *_workerQueue;
    MMConfSDKNativeCallbackMgr *_nativeCallbackMgr;
    MMConfSDKMemberMgr *_memberMgr;
    MMConfSDKAudioMgr *_audioMgr;
    MMConfSDKVideoMgr *_videoMgr;
...
- (int)gotXpsData:(id)arg1 codecType:(int)arg2 streamID:(int)arg3;
- (int)gotEncodedData:(id)arg1 isKeyFrame:(_Bool)arg2 codecType:(int)arg3 streamID:(int)arg4;
- (void)onCameraStop;
- (void)onCameraStart;
