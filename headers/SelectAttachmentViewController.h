...
@interface SelectAttachmentViewController : MMUIViewController <SelectAttachmentViewDelegate, SelectAttachmentViewDataSource, MMTransparentButtonDelegate, IAppDataExt>
{
    ...
    _Bool _allowChatRoomLive;
    _Bool _allowCamera;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool allowCamera; // @synthesize allowCamera=_allowCamera;
@property(nonatomic) _Bool allowChatRoomLive; // @synthesize allowChatRoomLive=_allowChatRoomLive;
