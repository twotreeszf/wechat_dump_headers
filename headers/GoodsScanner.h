...
@class CLLocation, CameraScanGoodsAdInfo, CameraScanGoodsJSAPIInfo, CameraScannerViewWrapper, LocationRetriever, NSMutableSet, NSObject, NSRecursiveLock, NSString;
...
@interface GoodsScanner : MMUIView <CNetworkStatusExt, LocationRetrieveDelegate, IScanGoodsServiceExt, CameraScannerViewDelegate>
{
    ...
    unsigned int _scanSessionIDForLocation;
...
@property(nonatomic) unsigned int scanSessionIDForLocation; // @synthesize scanSessionIDForLocation=_scanSessionIDForLocation;
