...
- (void)GetA8Key:(id)arg1 Scene:(unsigned int)arg2 subScene:(unsigned int)arg3 codeType:(unsigned int)arg4 codeVersion:(unsigned int)arg5 fromUser:(id)arg6 reqSourceUsername:(id)arg7;
