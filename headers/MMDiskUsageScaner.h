...
- (void)p_addMsgImageTypeStat:(id)arg1 filePath:(const char *)arg2 bizType:(long long)arg3 fileSize:(unsigned long long)arg4;
- (void)addSpecialFileStat:(id)arg1 filePath:(const char *)arg2 bizType:(long long)arg3 fileSize:(unsigned long long)arg4;
