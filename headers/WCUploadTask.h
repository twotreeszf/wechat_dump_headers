...
@class MMMusicShareItem, NSDate, NSMutableArray, NSMutableDictionary, NSString, SnsObject, SnsWeAppInfo, UserOpInfo, WCActionInfo, WCAppInfo, WCAppMsgShareInfo, WCBrandMpVideoItem, WCDataItem, WCFinderContentColumnSharedItem, WCFinderLiveShareItem, WCFinderShareItemContainer, WCFinderShareToMomentsItem, WCFinderTopicShareItem, WCLocationInfo, WCMegaVideoShareItem, WCMusicInfo, WCNoteInfo, WCStreamVideoInfo, WCVideoFlowInfo, WCWeAppInfo;
