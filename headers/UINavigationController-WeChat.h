...
#import "WCFinderTransitionControllerDelegate-Protocol.h"

@class NSMutableArray, NSString;

@interface UINavigationController (WeChat) <WCFinderTransitionControllerDelegate, UINavigationControllerDelegate>
...
- (_Bool)transitionControllerShouldPop:(id)arg1;
