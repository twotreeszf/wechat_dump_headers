...
@class AAQueryDetailRes, MMTableView, MMTipsViewController, NSMutableArray, NSString, WCPayGPOrderStatusHeaderView, WCPayGPPhotoViewController, WCPayRemarkPageSheet, WCPayWebImageView;
@protocol WCPayGPOrderStatusViewControllerDelegate;

@interface WCPayGPOrderStatusViewController : WCPayBaseViewController <UITableViewDelegate, UITableViewDataSource, ILinkEventExt, MMTipsViewControllerDelegate, WCPayWebImageViewDelegate, WCPayGPPhotoViewControllerDelegate, WCPayRemarkPageSheetDelegate>
{
