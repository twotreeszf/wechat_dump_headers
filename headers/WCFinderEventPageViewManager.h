...
- (void).cxx_destruct;
@property(retain, nonatomic) MMUIViewController<WCFinderFeedBaseViewControllerProtocol> *currentViewController; // @synthesize currentViewController=_currentViewController;
...
- (void)finderEventReloadHeaderViewWithEventInfo:(id)arg1;
...
- (id)initWithTopicParams:(id)arg1 innerTabType:(long long)arg2 view:(id)arg3 InViewController:(id)arg4;
