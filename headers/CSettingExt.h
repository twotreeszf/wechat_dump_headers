...
@interface CSettingExt : NSObject <NSCoding>
{
    ...
    unsigned int webViewSessionUrlRecordTime;
    unsigned int webviewMoveViewX;
    unsigned int webViewMoveViewY;
...
@property(nonatomic) unsigned int webViewMoveViewY; // @synthesize webViewMoveViewY;
@property(nonatomic) unsigned int webviewMoveViewX; // @synthesize webviewMoveViewX;
@property(copy, nonatomic) NSString *webviewSessionId; // @synthesize webviewSessionId;
@property(nonatomic) unsigned int webViewSessionUrlRecordTime; // @synthesize webViewSessionUrlRecordTime;
