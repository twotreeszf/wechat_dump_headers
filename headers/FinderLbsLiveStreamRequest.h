...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, FinderLbsTabTipsInfo, FinderLiveClientStatus, FinderLiveTabInfo, FinderSwitch, NSData, NSMutableArray;
