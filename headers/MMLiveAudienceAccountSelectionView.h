...
@protocol MMLiveAudienceAccountSelectionLogicDelegate;

@interface MMLiveAudienceAccountSelectionView : MMPageSheetBaseView <MMLiveHalfScreenTitleBarViewDelegate, WCFinderLiveExt, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource>
{
    MMFinderLiveTaskId *_taskId;
    MMTableView *_accountTableView;
    id <MMLiveAudienceAccountSelectionLogicDelegate> _logicDelegate;
...
@property(nonatomic) __weak id <MMLiveAudienceAccountSelectionLogicDelegate> logicDelegate; // @synthesize logicDelegate=_logicDelegate;
@property(retain, nonatomic) MMTableView *accountTableView; // @synthesize accountTableView=_accountTableView;
