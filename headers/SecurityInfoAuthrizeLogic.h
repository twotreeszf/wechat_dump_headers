...
@property(nonatomic) NSString *customPrivacyUrl; // @synthesize customPrivacyUrl=_customPrivacyUrl;
@property(nonatomic) NSString *customAuthTitle; // @synthesize customAuthTitle=_customAuthTitle;
