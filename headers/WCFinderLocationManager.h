...
@class CLLocation, CLLocationManager, LocationRetriever, MMTimer, NSCache, NSMutableArray, NSString;
@protocol WCFinderLocationManagerDelegate;

@interface WCFinderLocationManager : NSObject <LocationRetrieveDelegate, CLLocationManagerDelegate>
{
    _Bool _updating;
    _Bool _debugOn;
...
@property(retain, nonatomic) MMTimer *overTimeTimer; // @synthesize overTimeTimer=_overTimeTimer;
