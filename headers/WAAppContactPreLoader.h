...
- (void)openAppWithMPLinkString:(id)arg1 forbidAlert:(_Bool)arg2 fromScene:(unsigned long long)arg3 sceneNote:(id)arg4 preScene:(unsigned long long)arg5 preSceneNote:(id)arg6 onSuccess:(CDUnknownBlockType)arg7 onFailed:(CDUnknownBlockType)arg8;
