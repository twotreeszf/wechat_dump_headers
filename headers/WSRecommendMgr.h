...
@class MMTimer, NSDictionary, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, UIImage, WSLocalWebViewController, WSRecommendColikeStorage, WSRecommendColikeTempModel, WSRecommendHomePageStat, WSRecommendSetting;

@interface WSRecommendMgr : WSTemplateBaseMgr <WSLocalWebViewControllerDelegate, IFunctionMsgExt, MMKernelExt, PBMessageObserverDelegate, IMinimizeTaskDelegateInterface>
{
...
- (id)minimizePendingTaskContextWithTaskBizKey:(id)arg1 generateType:(int)arg2 wsVideoVC:(id)arg3;
