...
@class MMWebImageView, NSString, UIButton, UILabel, WCFinderFeedContentTouchExpandTextView, WCFinderFeedContentVM;
@protocol WCFinderContentHeaderViewDelegate;

@interface WCFinderContentHeaderView : UIView <WCFinderFeedContentTextClickActionDelegate>
{
    _Bool _isExpend;
