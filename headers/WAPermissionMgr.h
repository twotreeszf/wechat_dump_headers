...
- (_Bool)requestPluginPermissonInfoWithAppID:(id)arg1 userName:(id)arg2 isFirstTime:(_Bool)arg3 isolatePluginCount:(int)arg4 debugModeType:(unsigned int)arg5 pluginIDArray:(id)arg6;
