...
- (void).cxx_destruct;
- (void)updateButtonWithColor:(id)arg1 fontColor:(id)arg2 fontSize:(double)arg3 fixHeight:(double)arg4 withBorder:(_Bool)arg5 radius:(double)arg6 fontAlphaHighLighted:(double)arg7;
- (id)init;
