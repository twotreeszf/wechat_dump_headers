...
@class JSContext, JSVirtualMachine, MMContext, NSArray, NSCondition, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSThread, WAAppTaskExtInfo, WAApptaskPublicResLogic, WAContact, WAJSCServiceInjectExtendScriptModel, WAJSContextPluginScheduler, WAJSCoreServiceOpenData, WAPackageConfig, WAWebViewController, WXAudioNative, WxaExternalInfo, wxNative;
@protocol WAJSCoreServiceDelegate, WAJSCoreServiceRemoteDelegate, WAJSServiceProtocol;

@interface WAJSCoreService : WAJSNativeBufferBase <WAJSServicePluginContextProtocol, wxNativeLogDelegate, wxNativeReportDelegate, WXFileLoaderDelegate, wxAudioNativeLogDelegate, wxAudioFileLoaderDelegate, WAJSEventHandlerContextDelegate, WAJSServiceProtocol>
{
    ...
    shared_ptr_013fd618 _bindingApp;
}
...
@property shared_ptr_013fd618 bindingApp; // @synthesize bindingApp=_bindingApp;
...
- (_Bool)isNativeWeApp;
- (shared_ptr_013fd618)getBindingApp;
...
- (void)setupInvokeHandler:(id)arg1 param:(id)arg2 callbackId:(unsigned int)arg3 contextId:(unsigned int)arg4 workerId:(unsigned int)arg5;
