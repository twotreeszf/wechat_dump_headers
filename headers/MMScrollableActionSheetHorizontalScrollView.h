...
@interface MMScrollableActionSheetHorizontalScrollView : UIScrollView <MMScrollableActionSheetHorizontalItemViewDelegate>
{
    ...
    NSMutableDictionary *_itemType2ItemViewMap;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *itemType2ItemViewMap; // @synthesize itemType2ItemViewMap=_itemType2ItemViewMap;
