...
@class MMWebImageView, SightIconView, UIImageView, UILabel, UIView, WCBaseCardShareViewModel;

@interface WCBaseCardShareView : WCContentItemBaseView
{
    WCBaseCardShareViewModel *_viewModel;
...
@property(retain, nonatomic) WCBaseCardShareViewModel *viewModel; // @synthesize viewModel=_viewModel;
