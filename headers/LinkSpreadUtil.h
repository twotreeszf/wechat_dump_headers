...
+ (void)logViewWebView:(id)arg1 getA8KeyScene:(unsigned int)arg2 enterTime:(unsigned int)arg3 stayTimeInMS:(unsigned long long)arg4 adId:(id)arg5 appId:(id)arg6 referUrl:(id)arg7 webViewTitle:(id)arg8 webViewDesc:(id)arg9;
