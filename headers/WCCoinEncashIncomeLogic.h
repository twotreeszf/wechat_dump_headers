...
@class KindaProgressDialog, NSString, PrepareIncomeEncashResponse, WCCoinEncashParameter, WCCoinFetchMoneyInputViewController, WCCoinInterceptLogic;
@protocol WCCoinEncashIncomeLogicDelegate;

@interface WCCoinEncashIncomeLogic : MMObject <WCCoinPrepareIncomeEncashCgiDelegate, WCCoinEncashIncomeCgiDelegate, WCCoinFetchMoneyInputViewControllerDelegate, WCPayJSApiVerifyDelegate, WCPayPaidSuccessStatusViewControllerDelegate>
{
