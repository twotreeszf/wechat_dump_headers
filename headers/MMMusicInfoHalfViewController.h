...
@class CAGradientLayer, MMMusicHorizontalScrollingView, MMMusicInfo, MMMusicMVModel, MMUIButton, MMUILabel, MMWebImageView, NSString, UIImageView, UILabel, UIPanGestureRecognizer, UIView;
...
- (void)viewDidLoad;
- (id)initWithInfo:(id)arg1 mvModel:(id)arg2;
