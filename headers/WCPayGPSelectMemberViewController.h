...
@class MMTableView, MMUILabel, MMUIView, NSArray, NSMutableArray, NSString, UICollectionView, UIImageView, UITextField;
...
@interface WCPayGPSelectMemberViewController : WCPayBaseViewController <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource>
{
    ...
    double _kSelectMemberTableViewCellHeight;
    double _kSelectMemberToolBarHeight;
...
@property(nonatomic) double kSelectMemberToolBarHeight; // @synthesize kSelectMemberToolBarHeight=_kSelectMemberToolBarHeight;
@property(nonatomic) double kSelectMemberTableViewCellHeight; // @synthesize kSelectMemberTableViewCellHeight=_kSelectMemberTableViewCellHeight;
