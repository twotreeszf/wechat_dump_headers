...
@protocol WCFinderPatMusicCollectionReusableViewDelegate;

@interface WCFinderPatMusicCollectionReusableView : UICollectionReusableView <EditVideoBGMPlayerDelegate>
{
    id <WCFinderPatMusicCollectionReusableViewDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderPatMusicCollectionReusableViewDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)updatePatMusicWithBgmInfo:(id)arg1 patCount:(unsigned long long)arg2 titleWording:(id)arg3 enablePostFeed:(_Bool)arg4;
