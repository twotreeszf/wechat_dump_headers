...
@class NSArray, NSString, UIColor, UIImpactFeedbackGenerator;
...
- (void)dealloc;
- (id)initWithImageUrl:(id)arg1 imageColor:(id)arg2 imageSize:(struct CGSize)arg3 paddingBottom:(double)arg4 clockwise:(_Bool)arg5;
