...
@class AVCaptureDeviceInput, AVCaptureSession, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, NSMutableArray, NSRecursiveLock, NSString, ProcessPixelBuffer, UIImage, WeVisVoipEffectMgr;
...
- (void)dealloc;
- (void)setCropRegion:(int)arg1 dstHeight:(int)arg2;
- (_Bool)setGPUReslution:(int)arg1 height:(int)arg2;
