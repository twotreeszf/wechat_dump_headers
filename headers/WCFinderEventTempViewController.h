...
@class FinderGetTopicListResponse, FinderLocation, MMWebImageView, NSArray, NSMutableArray, NSMutableDictionary, NSString, RecommendedMusicInfo, UIBarButtonItem, UICollectionReusableView, UIImageView, UILabel, UIMonitorCollectionView, UITapGestureRecognizer, UIView, WCActionSheet, WCActionSheetWithHeadAvatar, WCFinderAnimationLoadingView, WCFinderCreateCoordinator, WCFinderSectionInfo, WCFinderStreamFooterView, WCFinderStreamLayout, WCFinderTagHeaderCollectionReusableView, WCFinderTopicListViewModel;

@interface WCFinderEventTempViewController : MMUIViewController <WCFinderTopicListViewModelDelegate, WCFinderStreamLayoutDelegate, UICollectionViewDelegate, UICollectionViewDataSource, WCFinderFeedStaticCoverCollectionViewCellDelegate, WCFinderStreamFooterViewActionDelegate, WCFinderTopicListSectionHeaderViewDelegate, MMScrollActionSheetDelegate, WCFinderTagHeaderCollectionReusableViewDelegate, WCGeneralCollectionMonitorExt, WCFinderPatMusicCollectionReusableViewDelegate, WCActionSheetDelegate, MMSightCameraViewControllerDelegate, WCFinderCameraViewControllerDelegate, WCFinderPostViewControllerDelegate, WCGeneralMonitorDelegate, WCFinderVideoDownLoadMgrExt, WCFinderEventHeaderViewDelegate, MMWebImageViewDelegate, WCFinderInvalidEventViewDelegate, WCFinderCreateCoordinatorDelegate, CAAnimationDelegate, MMNavBarInteractiveDelegate, WCFinderFeedBaseViewControllerProtocol>
{
...
@property(retain, nonatomic) UIView *scrollChangeColorView; // @synthesize scrollChangeColorView=_scrollChangeColorView;
