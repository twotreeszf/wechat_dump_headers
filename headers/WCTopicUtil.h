...
+ (id)doPushSearchResultromScene:(int)arg1 query:(id)arg2 tagCtrlInfo:(id)arg3;
+ (id)pushTimeLineTopicSearchResultFromScene:(int)arg1 query:(id)arg2 dataItem:(id)arg3 commentItem:(id)arg4;
+ (id)pushChatTopicSearchResultFromScene:(int)arg1 query:(id)arg2;
