...
@class NSMutableArray, NSString, UIImage, UIView, UIViewController, WAContact, WAH5ViewControllerParameter, WAProfileViewControllerParameter, WAReportWebViewErrorPageItem, WAWebViewController, WAWebViewControllerMenuItemModel;
