...
@class CContact, ContactRemarkLogic, MMTableViewInfo, NSMutableArray, NSMutableDictionary, NSString, UIImage, UIImageView, UILabel, UITextField, UITextView, UIView, WCTableViewSectionManager;

@interface RemarkViewController : MMUIViewController <IContactTagViewControllerExt, IOplogExt, IOpenImOplogExt, ContactRemarkImgExt, UITextViewDelegate, UITextFieldDelegate, WCActionSheetDelegate, MMImagePickerManagerDelegate, CommonImageBrowserDelegate, MMTableViewInfoDelegate>
{
