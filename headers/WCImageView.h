...
@class MMDragManager, NSString, UIDragInteraction, UIImage, UIImageView, UILabel, UITapGestureRecognizer, UIView, WCDataItem, WCMediaItem;
...
@interface WCImageView : MMUIControl <WCFacadeExt, WCActionSheetDelegate, WCForceTouchPreviewProtocol, MMDragDelegate>
{
    ...
    long long m_uiImageType;
    long long m_uiPrecedentImageType;
    unsigned int m_uiSourceType;
    _Bool m_bIsLongPressHandled;
    long long m_style;
    long long m_photoType;
...
@property(nonatomic) long long m_photoType; // @synthesize m_photoType;
@property(nonatomic) long long m_style; // @synthesize m_style;
...
@property(readonly, nonatomic) long long m_uiImageType; // @synthesize m_uiImageType;
...
- (void)dealloc;
- (id)initWithMediaData:(id)arg1 imageType:(long long)arg2 isGridPreviewImg:(_Bool)arg3;
- (id)initWithMediaData:(id)arg1 imageType:(long long)arg2 precedentImageType:(long long)arg3;
- (id)initWithMediaData:(id)arg1 imageType:(long long)arg2;
- (void)initData:(id)arg1 imageType:(long long)arg2 precedentImageType:(long long)arg3;
