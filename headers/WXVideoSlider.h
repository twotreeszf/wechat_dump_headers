...
@interface WXVideoSlider : UISlider
{
    ...
    CDUnknownBlockType _accessibilityHandler;
}

- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType accessibilityHandler; // @synthesize accessibilityHandler=_accessibilityHandler;
