...
@class CADisplayLink, MMWebImageView, NSMutableArray, NSObject, NSString, NSURLRequest, RCDraggableButton, UILabel, UIView, WAGameActionSheet, WAGameEvaluatePopSheet, WAGameRollProgressView, WAOpenGLView, YYWAWebView;
...
- (void)pauseGLView;
- (void)setGlCaptureDelegate:(unsigned int)arg1 delegate:(id)arg2;
...
- (id)downloadFile:(id)arg1 header:(id)arg2 filePath:(id)arg3 cleanMode:(_Bool)arg4 timeout:(unsigned int)arg5 complete:(CDUnknownBlockType)arg6 progress:(CDUnknownBlockType)arg7 header:(CDUnknownBlockType)arg8 useQuic:(_Bool)arg9 useHttp2:(_Bool)arg10 useCache:(_Bool)arg11 useProfile:(_Bool)arg12;
