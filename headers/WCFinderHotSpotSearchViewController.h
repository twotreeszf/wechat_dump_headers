...
@class MMTagTextField, NSMutableDictionary, NSString, UIImageView, UILabel, UIMonitorCollectionView, UIPanGestureRecognizer, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderSearchHistoryListView, WCFinderSearchHotSpotView, WCFinderSearchViewModel, WCFinderStreamFooterView, WCFinderStreamLayout, WCFullScreenTitleView;
...
- (void)finderSearchView:(id)arg1 didSelectedHotSpot:(id)arg2;
