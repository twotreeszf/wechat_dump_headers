...
@class CameraReflectDevice, FaceRecogCheckBrightnessLogic, FaceRecogReflectGuideView, FaceRecogReflectLightView, MMTimer, NSString;

@interface FaceRecogActionReflectHandler : FaceRecogFlashHandler <FaceRecogGuideViewDelegate, FaceRecogReflectLightViewDelegate, FaceRecogCheckBrightnessLogicDelegate>
{
