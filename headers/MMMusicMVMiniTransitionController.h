...
@interface MMMusicMVMiniTransitionController : NSObject <MinimizeEdgeGestureHandlerDelegate, UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate, UINavigationControllerDelegate>
{
