...
@class CAGradientLayer, NSString, UIImageView, WCFinderDynamicIconFetchToken, WCFinderFeedImageCDNView, WCFinderFeedStaticCoverInfoView, WCFinderLiveNowView;
@protocol WCFinderFeedStaticCoverViewDelegate, WCFinderLiveIconAnimationProtocol;

@interface WCFinderFeedStaticCoverView : UIView <WCFinderFeedImageCDNViewDelegate, WCFinderDynamicFetchIconDelegate, WCFinderLiveExt>
{
    _Bool _isShowStickyTop;
    id <WCFinderFeedStaticCoverViewDelegate> _delegate;
    ...
    WCFinderDynamicIconFetchToken *_likedIconToken;
...
@property(retain, nonatomic) WCFinderDynamicIconFetchToken *likedIconToken; // @synthesize likedIconToken=_likedIconToken;
...
@property(nonatomic) __weak id <WCFinderFeedStaticCoverViewDelegate> delegate; // @synthesize delegate=_delegate;
