...
@interface MMMusicPostVideoGetRelatedListCGI : WCFinderBaseCgi
{
...
- (void)createRequest;
- (id)initWithLastBuff:(id)arg1 tid:(id)arg2 nonceID:(id)arg3 recommendReason:(id)arg4 location:(id)arg5 tabType:(unsigned long long)arg6 source:(id)arg7 sectionInfo:(id)arg8 categoryRecommend:(id)arg9 streamLastBuffer:(id)arg10 viewerScene:(unsigned long long)arg11 fromUsername:(id)arg12 toUsername:(id)arg13 relatedEntranceInfo:(id)arg14 clientStatus:(id)arg15 successful:(CDUnknownBlockType)arg16 failure:(CDUnknownBlockType)arg17;
