...
@class MMUIButton, MMUILabel, NSString, UIImageView, UILabel, WCFinderDynamicIconFetchToken;
@protocol WCFinderFeedToolbarActionDelegate;

@interface WCFinderFullCollectionToolbarView : UIView <WCFinderLongPressIntervalGestureRecognizerDelegate, WCFinderDynamicFetchIconDelegate, WCActionSheetDelegate>
{
    _Bool _allowFav;
    _Bool _isFav;
    ...
    WCFinderDynamicIconFetchToken *_normalLikeIcon;
    WCFinderDynamicIconFetchToken *_emptyLikeIcon;
    WCFinderDynamicIconFetchToken *_groupLikeIcon;
...
@property(retain, nonatomic) WCFinderDynamicIconFetchToken *groupLikeIcon; // @synthesize groupLikeIcon=_groupLikeIcon;
@property(retain, nonatomic) WCFinderDynamicIconFetchToken *emptyLikeIcon; // @synthesize emptyLikeIcon=_emptyLikeIcon;
@property(retain, nonatomic) WCFinderDynamicIconFetchToken *normalLikeIcon; // @synthesize normalLikeIcon=_normalLikeIcon;
...
- (id)dynamicFetchImageIconIdentify:(SEL)arg1 svgColor:(id)arg2 dyeingImageWithColor:(_Bool)arg3;
- (void)prepareLikeIcon;
