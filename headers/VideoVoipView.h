...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, CMessageWrap, MultiTalkHDHeadView, NSString, UIButton, UIImageView, UILabel, UIView, VideoVoipTalkingView, VoipMinimizeReportObject, WCUIAlertView;
...
@property(nonatomic) _Bool isMuteModeOpen; // @synthesize isMuteModeOpen=_isMuteModeOpen;
