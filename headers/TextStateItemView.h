...
@class CContact, NSString, UIImageView;

@interface TextStateItemView : UIView <TextStateMgrExt>
{
    CContact *_contact;
    UIImageView *_stateEmojiImageView;
    struct CGSize _stateEmojiSize;
}

- (void).cxx_destruct;
@property(nonatomic) struct CGSize stateEmojiSize; // @synthesize stateEmojiSize=_stateEmojiSize;
@property(retain, nonatomic) UIImageView *stateEmojiImageView; // @synthesize stateEmojiImageView=_stateEmojiImageView;
