...
@class FileDetailLogicController, ImageScrollView, MMCircleProgressView, MMUILabel, MiniRecTransitionController, NSString, NSURL, ShareDataToOpenSDKController, UIButton, UIImageView, UITapGestureRecognizer, WCActionSheet, WKWebView, WXFullScreenGestureRecognizer;
