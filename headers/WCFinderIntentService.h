...
@interface WCFinderIntentService : MMUserService <NSCacheDelegate, MMServiceProtocol>
{
    NSCache *_intentCache;
}

+ (id)hashIntent:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) NSCache *intentCache; // @synthesize intentCache=_intentCache;
