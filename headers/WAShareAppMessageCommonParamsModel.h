...
- (id)toShareAppMessageContextModelWithWAContact:(id)arg1 cardType:(int)arg2 shouldUseUpdatableShare:(_Bool)arg3 updatableShareTemplateId:(id)arg4 isTodoMessage:(_Bool)arg5 toDoActivityId:(id)arg6 isPrivateMessage:(_Bool)arg7;
- (id)description;
