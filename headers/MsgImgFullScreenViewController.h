...
#import "MMScrollableActionSheetWithVerticalRowsDelegate-Protocol.h"
...
@class BrandMpVideoReporter, CAGradientLayer, CMessageWrap, CameraScanCodesMarkDotView, EditImageForwardAndEditLogicController, ForwardMessageLogicController, GetQRCodeInfoLogic, ImageBrowseButton, ImageScrollView, MMAdaptiveBubbleViewWithLabel, MMProgressViewEx, MMScrollableActionSheetWithVerticalRows, MMTimer, MMUIActivityIndicatorView, MPCustomInteractiveHandler, MPDragDownGestureHandler, MessageInterceptReporter, MsgImgDataLogic, MsgImgDelayEntryReporter, MsgImgFullScreenContainer, MsgImgPreviewData, MsgImgSearchPhashMemCache, NSArray, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString, OCRTransHalfScreenViewController, ScanQRCodeLogicController, ShareDataToOpenSDKController, SightIconView, UILabel, UIView, WCActionSheet, WCImageTranslateLogic;
@protocol MsgImgFullScreenViewControllerDelegate;

@interface MsgImgFullScreenViewController : MMUIViewController <MMScrollableActionSheetWithVerticalRowsDelegate, GetQRCodeInfoLogicDelegate, BaseScanLogicDelegate, WXVideoPlayerViewDelegate, WXVideoPlayerViewTouchDelegate, MsgImgDataLogicDelegate, ForwardMessageLogicDelegate, EditImageForwardAndEditLogicDelegate, WCImageTranslateDelegate, WCActionSheetDelegate, MMUIHalfScreenViewControllerDelegate, UIViewControllerTransitioningDelegate, MsgImgFullScreenContainerDelegate, IDownloadImageExt, IMsgExt, IMsgRevokeExt, UIViewControllerAnimatedTransitioning>
{
    ...
    MMScrollableActionSheetWithVerticalRows *_scrollableActionSheet;
}

+ (_Bool)isHDImageDownloaded:(id)arg1;
+ (_Bool)isMiddleImgDownload:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) MMScrollableActionSheetWithVerticalRows *scrollableActionSheet; // @synthesize scrollableActionSheet=_scrollableActionSheet;
...
- (_Bool)shouldShowTranslateEntry;
- (_Bool)isQrCodeDetected;
- (_Bool)isQrCodeBeginDetect;
- (_Bool)isPreTranslateDetected;
- (_Bool)isTranslateBeginDetect;
- (double)getTranslateFastEntryConfigRate;
