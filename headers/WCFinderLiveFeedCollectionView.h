...
@interface WCFinderLiveFeedCollectionView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, LOTColorValueDelegate, WCGeneralMonitorDelegate>
{
    _Bool _isInDarkMode;
