...
@class MMFinderLiveRewardGiftItem, MMFinderLiveTaskId, MMLiveRewardGiftSelectionView, MMLiveRewardGiftSendingMoreBubbleView, NSMutableArray, NSMutableDictionary, NSString;
...
- (void)chargeCoinWithFromPage:(id)arg1;
