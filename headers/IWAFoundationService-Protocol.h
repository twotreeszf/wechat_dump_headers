...
+ (_Bool)StartCronetSimpleRequest:(NSString *)arg1 withUrl:(NSString *)arg2 withNewDNS:(_Bool)arg3;
+ (_Bool)StartCronetFileDownload:(NSString *)arg1 withUrl:(NSString *)arg2 withSavePath:(NSString *)arg3 withIPList:(NSArray *)arg4 withIsGzip:(_Bool)arg5 withFileType:(int)arg6 withNewDNS:(_Bool)arg7;
