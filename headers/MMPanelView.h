...
@class FixTitleColorButton, NSString, UIButton, UILabel, UIView, WCPayCss;
...
@interface MMPanelView : WCPayNavigationView
{
    ...
    UIView *_footerView;
    FixTitleColorButton *_leftButton;
...
@property(retain) FixTitleColorButton *rightButton; // @synthesize rightButton=_rightButton;
@property(retain) UIView *bottomButtonInternalView; // @synthesize bottomButtonInternalView=_bottomButtonInternalView;
@property(retain) FixTitleColorButton *leftButton; // @synthesize leftButton=_leftButton;
