...
@class AddressBookFriend, CContact, CContactVerifyLogic, ContactInfoViewController, FTSKeyBoardSugBar, FTSWebSearchController, FTSWebSearchPardusWebHeaderView, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIView, WCTimeLineFooterView, WCWebSearchViewControllerNewH5;

@interface FTSVoiceSearchBarController : MMNewVoiceSearchBar <FTSKeyBoardSugBarDelegate, WCPayWalletLockVerifyLogicDelegate, IFTSContactMgrExt, IFTSMemorySearchMgrExt, IFTSMessageMgrExt, IFTSFavMgrExt, IWALocalSearchExt, IMiniGameSearchExt, IWANetSearchExt, ContactInfoViewControllerDelegate, contactVerifyLogicDelegate, contactInfoDelegate, PBMessageObserverDelegate, MFMessageComposeViewControllerDelegate, ContactPickerViewDelegate, FTSWebSearchViewDelegate, IFtsWebSearchExt, WebSearchLocalPageCellDelegate, IWSSearchUtilExtension, FTSWebSearchBaseResultTableViewCellDelegate, FTSWebSearchResultSugCellDelegate, FTSWebSearchResultWAWidgetCellDelegate, IWSViewControllerLifeCycleExt, FTSWebSearchPardusWebHeaderViewDelegate, IWAWidgetLocalSearchExt, WCWebSearchViewControllerDelegate, MMWebViewDelegate, FTSFeatureDetailViewDelegate, SearchGuideViewDelegate, FTSResultViewDelegate, FTSAddressBookFriendCellDelegate, WCActionSheetDelegate, MMUIViewControllerDelegate>
{
