...
- (void)saveMainThreadHandle:(_Bool)arg1 withFrameDropLimit:(unsigned long long)arg2 withPerStackInterval:(unsigned long long)arg3 withDeviceUnder:(int)arg4 withMainThreadCount:(int)arg5;
