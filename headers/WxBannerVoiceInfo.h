...
@interface WxBannerVoiceInfo : WXPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *createOpenid; // @dynamic createOpenid;
@property(retain, nonatomic) NSMutableArray *memberList; // @dynamic memberList;
@property(nonatomic) unsigned long long memberListSeq; // @dynamic memberListSeq;
