...
- (void)editVideoViewController:(WCEditVideoViewController *)arg1 subEditor:(WCEditVideoViewController *)arg2 didFinishEditingVideo:(EditVideoAttr *)arg3 andForceChangeToScene:(unsigned int)arg4;
