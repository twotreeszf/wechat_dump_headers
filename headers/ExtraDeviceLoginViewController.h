...
@interface ExtraDeviceLoginViewController : MMWindowViewController <PBMessageObserverDelegate, WCImageFullScreeViewMgrExt, MMWebViewDelegate>
{
    UIView *m_backgroundView;
    _Bool _isFromReScanBtn;
    _Bool _syncChatLog;
    _Bool _needHandleWebViewCallBack;
...
@property(nonatomic) _Bool needHandleWebViewCallBack; // @synthesize needHandleWebViewCallBack=_needHandleWebViewCallBack;
...
@property(retain, nonatomic) NSString *usageLink; // @synthesize usageLink=_usageLink;
