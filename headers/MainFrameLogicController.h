...
@interface MainFrameLogicController : MMObject <INewSyncExt, IGroupMgrExt, INetworkStatusMgrExt, IMMNewSessionMgrExt, IWXTalkPresentExt, IContactMgrExt>
{
    ...
    NSMutableArray *m_visibleSessions;
}
...
- (long long)indexOfSessionUserName:(id)arg1;
- (void)checkLoadSessions;
- (void)rebuildVisibleSessions;
...
- (void)didEndDisplayCell:(unsigned int)arg1 isReloadingData:(_Bool)arg2;
- (void)willDisplayCell:(unsigned int)arg1 isReloadingData:(_Bool)arg2;
