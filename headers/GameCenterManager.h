...
- (_Bool)tryLaunchGameOrJumpDetail:(id)arg1 GameInfo:(id)arg2 AppMessage:(id)arg3 SourceScene:(long long)arg4 NeedUpdateLocalDetailInfo:(_Bool)arg5 LaunchGameResultBlock:(CDUnknownBlockType)arg6;
...
- (id)getGameNativeMsgCenterViewController:(long long)arg1 msgId:(id)arg2 msgTabType:(unsigned int)arg3;
- (id)getGameCenterLibraryViewController:(long long)arg1;
- (id)urlAppending:(id)arg1 AppendingStr:(id)arg2;
- (id)buildHomePageURLWithOriginUrl:(id)arg1 SourceScene:(long long)arg2 HasFloatLayer:(_Bool)arg3;
- (id)getGameCenterHomeWebViewController:(id)arg1 SourceScene:(long long)arg2 HasFloatLayer:(_Bool)arg3;
- (void)setRedDotBeforeHomeCgi:(id)arg1;
- (id)getGameCenterForeignNativeHomeViewController:(long long)arg1 EntranceRedDot:(id)arg2;
- (id)getGameCenterNativeHomeViewControllerV5:(long long)arg1 EntranceRedDot:(id)arg2;
- (id)createHomeViewControllerLab:(long long)arg1 EntranceRedDot:(id)arg2;
- (id)createHomeViewControllerIngoreGlobalSetting:(long long)arg1 EntranceRedDot:(id)arg2;
- (id)getGameCenterHomeViewController:(long long)arg1 EntranceRedDot:(id)arg2;
- (void)trackEventForOpenFloatLayerWithNotify:(id)arg1 SourceScene:(long long)arg2;
...
- (void)reportGameEntrnace:(_Bool)arg1 sourceScene:(long long)arg2 gameCenterVC:(id)arg3;
- (void)openHomeWithNavigationViewController:(id)arg1 SourceScene:(long long)arg2 Extra:(id)arg3;
- (id)createHomeViewController:(long long)arg1 EntranceRedDot:(id)arg2 Extra:(id)arg3;
- (id)popHomeViewController:(long long)arg1 EntranceRedDot:(id)arg2 Extra:(id)arg3;
...
- (long long)openGameDetailViewWithGameInfo:(id)arg1 navigationController:(id)arg2 NeedUpdateLocalDetailInfo:(_Bool)arg3 sourceScene:(long long)arg4;
- (void)openGameCenterDetailView:(id)arg1 appId:(id)arg2 sourceScene:(long long)arg3 webviewInfo:(id)arg4;
...
- (void)reportGameHomeABTestForSourceScene:(long long)arg1;
