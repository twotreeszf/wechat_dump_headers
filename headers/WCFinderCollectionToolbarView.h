...
@interface WCFinderCollectionToolbarView : UIView <WCFinderLongPressIntervalGestureRecognizerDelegate, WCFinderDynamicFetchIconDelegate, WCActionSheetDelegate>
{
    _Bool _isFav;
    ...
    WCFinderDynamicIconFetchToken *_normalLinkIcon;
...
@property(retain, nonatomic) WCFinderDynamicIconFetchToken *normalLinkIcon; // @synthesize normalLinkIcon=_normalLinkIcon;
...
- (id)dynamicFetchImageIconIdentify:(SEL)arg1 svgColor:(id)arg2;
