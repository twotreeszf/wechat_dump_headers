...
@protocol WCFinderMentionListViewModelDelegate;

@interface WCFinderMentionListViewModel : NSObject <WCFinderDataItemExt>
{
    _Bool _continueFlag;
    id <WCFinderMentionListViewModelDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderMentionListViewModelDelegate> delegate; // @synthesize delegate=_delegate;
