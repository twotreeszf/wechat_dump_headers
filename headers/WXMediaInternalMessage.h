...
@interface WXMediaInternalMessage : NSObject
{
    ...
    _Bool isAppBrandSecrectMessage;
    ...
    NSString *_songLyric;
    long long _tradingGuaranteeFlag;
...
@property(nonatomic) long long tradingGuaranteeFlag; // @synthesize tradingGuaranteeFlag=_tradingGuaranteeFlag;
...
@property(nonatomic) _Bool isAppBrandSecrectMessage; // @synthesize isAppBrandSecrectMessage;
