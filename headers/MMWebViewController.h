...
@class CAGradientLayer, CContact, EnterpriseConnectorLogic, FixDocumentPresent, ForwardMessageLogicController, GameWebReporter, MMJSApiVerifyMgr, MMScrollActionSheet, MMTimer, MMTipsViewController, MMURLHandler, MMWebBottomToolBar, MMWebCoreConfig, MMWebCustomLog, MMWebMProfileTitleView, MMWebProgressBar, MMWebTopBar, MMWebTransHelpButton, MMWebViewPerformance, MMWebViewPluginScheduler, MMWebViewPresetUI, MMWebviewPrefetchResult, MiniRecTransitionController, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURL, NSURLRequest, TipsView, UIButton, UIImageView, UILabel, UILongPressGestureRecognizer, UIView, UIViewController, WCDeepLinkHandler, WCWebNavigationEventsStore, WKNavigation, WKWebView, WebViewA8KeyLogicImpl, WebViewJSLogicImpl, WebViewMenuCustomizeLogic, WebViewOAuthLogic, WebViewSanboxSessionLogic, WebViewTimeProfileData;
@protocol MMWebViewDelegate, MMWebViewPreloadContentHandler, YYWebViewInterface;

@interface MMWebViewController : MMUIViewController <MMWebSearchViewDelegate, MMWebMProfileTitleViewDelegate, MinimizationTransitionControllerDelegate, MMWebViewDelegate, MMScrollActionSheetDelegate, EnterpriseConnectorLogicDelegate, H5GameScrollActionSheetDelegate, MMWebMenuHeaderViewDelegate, WCForceTouchPopProtocol, UIGestureRecognizerDelegate, IUiUtilExt, MMTipsViewControllerDelegate, ISysCallCheckExt, WCActionSheetDelegate, MMWebViewFontFloatViewDelegate, WebViewA8KeyLogicDelegate, WebViewJSLogicDelegate, UIScrollViewDelegate, MMJSApiVerifyMgrDelegate, ForwardMessageLogicDelegate, WCCommitViewResultDelegate, WebViewSanboxSessionLogicDelegate, WXCustomWebViewControllerProtocol, YYWebViewDelegate>
{
...
- (void)showNavBarShadow:(id)arg1 alpha:(float)arg2;
...
- (void)setupWebviewExpandedUIForGameCenterDebuger;
- (unsigned long long)webviewExpandedStatusBarPresetColor;
- (_Bool)isWebviewExpandedToTopForGameCenterDebugScene;
...
- (void)setFullScreen:(_Bool)arg1 scene:(unsigned int)arg2;
...
- (id)setupRow1WithForbidFlag:(unsigned int)arg1;
- (id)setupRow2WithForbidFlag:(unsigned int)arg1;
- (id)setupIconActionSheetCellsWithForbidFlag:(unsigned int)arg1;
- (void)addWebviewSearchButtonWithArray:(id)arg1;
- (id)setupHalfIconActionSheetWithForbidFlag:(unsigned int)arg1;
- (id)setupPreShowIconActionSheetWithForbidFlag:(unsigned int)arg1;
...
- (void)showMenuWithScene:(unsigned long long)arg1 forbidFlag:(unsigned int)arg2 anchorView:(id)arg3;
- (void)onOperate:(id)arg1;
- (void)reloadMenuActionSheetWithForceOption:(_Bool)arg1;
- (void)reloadMenuActionSheetIfNeeded;
- (id)buildMenuItems:(unsigned long long *)arg1 menuType:(unsigned long long *)arg2 forbidFlag:(unsigned int)arg3;
...
- (void)doShareWithAppMessage:(id)arg1 shareScene:(unsigned long long)arg2;
