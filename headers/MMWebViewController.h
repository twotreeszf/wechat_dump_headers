...
@class CAGradientLayer, CContact, EnterpriseConnectorLogic, MMJSApiVerifyMgr, MMScrollActionSheet, MMTimer, MMTipsViewController, MMURLHandler, MMWebBottomToolBar, MMWebCustomLog, MMWebProgressBar, MMWebTransitionController, MMWebViewPluginScheduler, MMWebViewPresetUI, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURLRequest, TipsView, UIButton, UIImageView, UILabel, UILongPressGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView, UIViewController, WCDeepLinkHandler, WKWebView<YYWebViewInterface>, WebViewA8KeyLogicImpl, WebViewJSLogicImpl, WebViewMenuCustomizeLogic, WebViewOAuthLogic, WebViewTimeProfileData;
...
- (void)setNavigationBarY:(double)arg1 shouldFilterSame:(_Bool)arg2;
...
- (_Bool)shrinkScrollViewShouldScrollToTop:(id)arg1;
- (void)shrinkScrollViewDidEndDecelerating:(id)arg1;
- (void)shrinkScrollViewDidEndScrollingAnimation:(id)arg1;
- (void)shrinkScrollViewDidEndDragging:(id)arg1 willDecelerate:(_Bool)arg2;
...
- (void)shrinkViewDidAppearInVarBar:(_Bool)arg1;
- (void)shrinkViewWillDisappearInNavBar:(_Bool)arg1;
