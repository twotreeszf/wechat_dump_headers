...
@interface MMKSMusicPlayer : MMRootService <IRemoteControlMusicPlayerExt, KSAudioPlayerDelegate, KSAudioPlayerUserDefineProtocol, KSAudioLogProtocol, MMServiceProtocol>
{
