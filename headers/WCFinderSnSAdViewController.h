...
@interface WCFinderSnSAdViewController : MMUIViewController <WCFinderSnSAdListViewModelDelegate, WCFinderFeedListViewDataSource, WCFinderFeedListViewDelegate, WCFinderFeedDetailStatusViewDelegate, WCFinderFeedBaseViewControllerProtocol>
{
...
- (void)viewDidLoad;
- (id)initWithTid:(id)arg1 nonceId:(id)arg2 userName:(id)arg3 reportModel:(id)arg4 encryptedlastTid:(id)arg5;
