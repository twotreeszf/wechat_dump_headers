...
@class NSDictionary, WSTemplatePackage;
...
@interface WSTemplatePackageManager : NSObject
{
    ...
    NSDictionary *_defaultConfigDic;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSDictionary *defaultConfigDic; // @synthesize defaultConfigDic=_defaultConfigDic;
