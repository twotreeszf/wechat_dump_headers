...
@class BrandTimelineViewController, CreateChatLogic, MFTitleView, MMLoadingView, MMMainTableView, MMSessionInfo, MMTimer, MainFrameHeaderLogic, MainFrameLogicController, NSString, UIDynamicAnimator, UIImageView, WAMainFrameTaskBarLogic, WAMainFrameTaskBarView, WAMainFrameTopHeaderView, WCBarMessageWindow;
