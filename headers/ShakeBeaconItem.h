...
+ (void)initialize;
+ (void)PBArrayAdd_wxaVersionType;
+ (void)PBArrayAdd_wxaPath;
+ (void)PBArrayAdd_wxaUsername;
+ (void)PBArrayAdd_shopId;
+ (void)PBArrayAdd_guideState;
+ (void)PBArrayAdd_distance;
+ (void)PBArrayAdd_minor;
+ (void)PBArrayAdd_major;
+ (void)PBArrayAdd_uuid;
+ (void)PBArrayAdd_createTime;
+ (void)PBArrayAdd_headImgUrlBig;
+ (void)PBArrayAdd_headImgUrlSmall;
+ (void)PBArrayAdd_url;
