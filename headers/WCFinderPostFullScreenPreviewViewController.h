...
@interface WCFinderPostFullScreenPreviewViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, WCFinderFeedContentVMExt, WCFinderFullMultiMediaTableViewCellDelegate, WCFinderContentTableViewCellDelegate, WCFinderVideoPlayerExt, WCFinderFeedBaseViewControllerProtocol, WCFinderShareCustomTransitionProtocol, MMScrollActionSheetDelegate, WCFinderMultiMediaTableViewCellDelegate, WCActionSheetDelegate>
{
    ...
    _Bool _hiddenShowHalfMediaButton;
...
@property(nonatomic) _Bool hiddenShowHalfMediaButton; // @synthesize hiddenShowHalfMediaButton=_hiddenShowHalfMediaButton;
...
- (void)viewDidLoad;
- (id)initWithHiddenShowHalfMediaButton:(_Bool)arg1 dismissBlock:(CDUnknownBlockType)arg2 hiddenFullScreenToolbarView:(_Bool)arg3 isAuthorPerspective:(_Bool)arg4;
