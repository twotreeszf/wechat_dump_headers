...
@class MMOnlineSilentDownloadLogicController, NSArray, NSMutableArray, NSMutableSet, NSNumber, NSString, SendActiveCGI;

@interface OnlineClientMgr : MMUserService <IMMLanguageMgrExt, PBMessageObserverDelegate, IMMNewSessionMgrExt, MMKernelExt, INewSyncExt, MMServiceProtocol>
{
