...
@class MMMusicInfo, MMMusicMVModel, MMMusicMVRecommendHeaderView, MMMusicMVRecommendTableCell, NSData, NSString, UIButton, UILabel, UIPanGestureRecognizer, UITableView, UIView, WCFinderLastestPlayVideoInfoMgr;
@protocol MMMusicMVRecommendViewControllerDataSource;

@interface MMMusicMVRecommendViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate, WCActionSheetDelegate, MMMusicMVRecommendTableCellDelegate, MMMusicMVRecommendHeaderViewDelegate>
{
    MMMusicInfo *_info;
    NSString *_songId;
    NSData *_lastBuff;
...
- (id)initWithInfo:(id)arg1 currentModel:(id)arg2;
