...
@class BaseRequest, NSString, WxaAppBaseInfo, WxaClientPublicLibInfo, WxaJumpInfo, WxaPluginInfo, WxaPushMsgInfo, WxaWebLaunchInfo;
...
@property(retain, nonatomic) WxaPushMsgInfo *wxaPushMsgInfo; // @dynamic wxaPushMsgInfo;
