...
@interface MMOpenVoiceService : MMUserService <ISysCallCheckExt, MonoServiceLogicExt, MMOpenVoiceVideoHWencDelegate, MMServiceProtocol>
{
    ...
    int _hwEncWPrev;
    int _hwEncHPrev;
    MMOpenVoiceVideoHWenc *_h264Encoder;
    NSString *m_iOSPath;
    int _hwFailedCnt;
    struct __sFILE *m_pfEncSteam;
    long long _hwFrameCnt;
    long long capframecnt;
}
...
- (void)doHWQosCtrl:(int)arg1 capHeight:(int)arg2 hwEncSwitch:(_Bool *)arg3 hwEncSkip:(_Bool *)arg4;
- (void)resetHWEncdoer;
...
- (void)join1v1ConferenceSync:(id)arg1 joinCallback:(CDUnknownBlockType)arg2 interruptedCallback:(CDUnknownBlockType)arg3 memberChangeCallback:(CDUnknownBlockType)arg4 videoMemberChangeCallback:(CDUnknownBlockType)arg5 speakerChangeCallback:(CDUnknownBlockType)arg6;
- (void)join1v1Conference:(id)arg1 joinCallback:(CDUnknownBlockType)arg2 interruptedCallback:(CDUnknownBlockType)arg3 memberChangeCallback:(CDUnknownBlockType)arg4 videoMemberChangeCallback:(CDUnknownBlockType)arg5 speakerChangeCallback:(CDUnknownBlockType)arg6;
