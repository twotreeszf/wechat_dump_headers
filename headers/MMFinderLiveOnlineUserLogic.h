...
- (void)onFinderGetLiveOnlineMember:(id)arg1 taskId:(id)arg2 onlineContacts:(id)arg3 rewardTotalAmountInHeat:(unsigned long long)arg4 onlineMemberCount:(unsigned int)arg5 selfLiveContact:(id)arg6;
