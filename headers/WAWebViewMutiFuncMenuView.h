...
@class MMUIActivityIndicatorView, MMUILabel, NSString, UIButton, UILongPressGestureRecognizer, UIView, WAPopOverTaskBarlogic, WAPopOverView, WAWebViewController;
