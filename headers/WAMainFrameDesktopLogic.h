...
#import "WAMainFrameDesktopViewDelegate-Protocol.h"
...
@interface WAMainFrameDesktopLogic : MMObject <WAAppItemManagerExtension, WAMainFrameDesktopViewDelegate, WAMainListStarLogicDelegate, WASearchControllerDelegate>
{
