...
@class InteractionLabel, MMAdaptiveLabel, MMHeadImageView, NSString, RichTextView, TextStateItemView, UIButton, UIImageView, UILabel, UIView, UrlLabel, WCDataItem;
...
+ (double)contentHeight:(id)arg1 trimDesc:(id)arg2 showDetail:(_Bool)arg3;
