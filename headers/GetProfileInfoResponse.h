...
@class BaseResponse, GetProfileInfoResponse_ServicePreInfo, GetProfileInfoResponse_WxaEvaluateBasicInfo, GetProfileInfoResponse_WxaLikeList, GetProfileInfoResponse_WxaRelateBrandList, GetProfileInfoResponse_WxaRelateWeAppList, NSString;
