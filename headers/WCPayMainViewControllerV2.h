...
@class GetEUInfoResp, NSDictionary, NSString, UICollectionView, UIImageView, UIView, WCPayMainViewLogicController, WCPayWalletEntryHeaderView;

@interface WCPayMainViewControllerV2 : WCBizBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, WCPayMainViewLogicControllerDelegate, WCPayRealNameTipsViewControllerDelegate, WCPayWalletEntryHeaderViewDelegate, WCPayWalletViewControllerDelegate, WCPayPwdViewControllerDelegate, ILinkEventExt, WCMallWalletMangeControlLogicDelegate, WCPayWalletCollectionViewFlowLayoutDelegate, WCPayUploadIDCardTipsViewControllerDelegate>
{
