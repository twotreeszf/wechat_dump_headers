...
- (void).cxx_destruct;
- (void)handleSendOCRImageData:(id)arg1;
- (void)sendOCRImageData:(id)arg1 context:(id)arg2;
- (void)cdnUploadAndSendOCRImage:(unsigned long long)arg1 imagePath:(id)arg2 scene:(unsigned int)arg3;
