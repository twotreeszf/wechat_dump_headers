...
@class NSArray, NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCFinderAbstractTask;
@protocol WCFinderFeedMachineVMDelegate;

@interface WCFinderFeedMachineVM : NSObject <WCFinderDataItemExt, WCFinderPostingCommentExt, WCFinderRedDotNotifyExt, WCFinderStreamPreFetchExt>
{
    ...
    NSMutableDictionary *_relatedFeedDic;
    NSMutableSet *_hasPreLoadRelatedSet;
    NSMutableSet *_hasShownRelatedSet;
...
@property(retain, nonatomic) NSMutableSet *hasShownRelatedSet; // @synthesize hasShownRelatedSet=_hasShownRelatedSet;
@property(retain, nonatomic) NSMutableSet *hasPreLoadRelatedSet; // @synthesize hasPreLoadRelatedSet=_hasPreLoadRelatedSet;
@property(retain, nonatomic) NSMutableDictionary *relatedFeedDic; // @synthesize relatedFeedDic=_relatedFeedDic;
...
- (void)preLoadRelatedListWithContentVM:(id)arg1;
