...
@interface WCFinderPrimarySettingViewController : MMUIViewController <WCFinderContactExt, WCFinderUserPrepareCgiDelegate, WCFinderRedDotExt>
{
...
- (void)addAccountMgrSection:(id)arg1;
- (void)addLiveLotterySection:(id)arg1;
- (void)addStoreSection:(id)arg1;
- (void)addProduceGuidSection:(id)arg1;
