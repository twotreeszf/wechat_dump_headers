...
@class MMUIButton, NSString, UICollectionReusableView, UICollectionView, UICollectionViewFlowLayout, UILabel, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderFeedLikeListViewModel, WCFinderStreamFooterView;

@interface WCFinderFeedLikeListViewController : MMUIHalfScreenViewController <UICollectionViewDataSource, UICollectionViewDelegate, WCFinderStreamFooterViewActionDelegate, WCFinderFeedLikeListViewModelDelegate, UICollectionViewDelegateFlowLayout>
{
