...
+ (void)initialize;
+ (void)PBArrayAdd_snsObjId;
+ (void)PBArrayAdd_snsBgId;
+ (void)PBArrayAdd_snsFlag;
+ (void)PBArrayAdd_albumBgId;
+ (void)PBArrayAdd_albumStyle;
+ (void)PBArrayAdd_albumFlag;
+ (void)PBArrayAdd_weiboNickname;
+ (void)PBArrayAdd_weibo;
+ (void)PBArrayAdd_sign;
+ (void)PBArrayAdd_headImgUrl;
+ (void)PBArrayAdd_hdHeadImgUrl;
+ (void)PBArrayAdd_city;
+ (void)PBArrayAdd_province;
+ (void)PBArrayAdd_country;
+ (void)PBArrayAdd_userNickName;
+ (void)PBArrayAdd_userName;
+ (void)PBArrayAdd_isVerified;
+ (void)PBArrayAdd_isRead;
+ (void)PBArrayAdd_ticket;
+ (void)PBArrayAdd_desc;
+ (void)PBArrayAdd_scene;
+ (void)PBArrayAdd_inviterNickName;
+ (void)PBArrayAdd_inviterName;
