...
@interface WAMsgNodeResourceMgr : MMUserService <WAPackageDownloadLogicDelegate, WAMsgNodeImageDownloadLogicDelegate, MMServiceProtocol>
{
...
- (void).cxx_destruct;
- (id)getLocalCacheDataWithFullUrl:(id)arg1 scene:(unsigned int)arg2 version:(unsigned long long)arg3;
