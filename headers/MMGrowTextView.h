...
- (void)parseAndAppendTopicSearchAttributeds:(id)arg1;
- (void)doParseTextAttri;
...
- (void)textView:(id)arg1 didPastedText:(id)arg2;
...
- (id)initWithOriginHeight:(double)arg1 WithDonotNeedTextViewContentTopBottomInset:(_Bool)arg2 extConfig:(id)arg3;
