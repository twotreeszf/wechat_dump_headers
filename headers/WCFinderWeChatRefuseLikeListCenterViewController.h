...
@class MMTableView, NSMutableArray, NSMutableDictionary, NSString, WCFinderRefuseLikeListModel, WCGroup, WCOpLog;
@protocol WCFinderWeChatRefuseLikeListCenterViewControllerDelegate;

@interface WCFinderWeChatRefuseLikeListCenterViewController : MMUIViewController <WCActionSheetDelegate, tableViewDelegate, NewChatRoomMemberItemViewDelegate, MultiSelectContactsViewControllerDelegate, IContactMgrExt, WCFacadeExt, WCCreateNewGroupViewControllerDelegate, UITableViewDataSource, UITableViewDelegate, WCFinderRefuseLikeListModelDelegate>
{
    WCGroup *_group;
    ...
    id <WCFinderWeChatRefuseLikeListCenterViewControllerDelegate> _delegate;
    WCFinderRefuseLikeListModel *_viewModel;
    NSString *_objectID;
    unsigned long long _reportScene;
    NSMutableArray *_addMembers;
    NSMutableArray *_delMembers;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *delMembers; // @synthesize delMembers=_delMembers;
...
@property(nonatomic) __weak id <WCFinderWeChatRefuseLikeListCenterViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)onDismiss;
- (id)initWithWCGroup:(id)arg1 objectID:(id)arg2 reportScene:(unsigned long long)arg3;
