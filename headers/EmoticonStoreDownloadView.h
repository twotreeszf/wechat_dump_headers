...
@class EmoticonStoreItem, EmotionProgressView, MMUIActivityIndicatorView, UIButton, UIImageView;
...
@interface EmoticonStoreDownloadView : UIView <IEmoticonPackageStateMgrExt, IEmoticonPackageMgrExt>
{
    ...
    MMUIActivityIndicatorView *_m_activityIndicatorView;
    long long _m_scene;
    long long _m_type;
    long long _type;
...
@property(retain, nonatomic) MMUIActivityIndicatorView *m_activityIndicatorView; // @synthesize m_activityIndicatorView=_m_activityIndicatorView;
