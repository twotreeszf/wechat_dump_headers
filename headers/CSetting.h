...
@interface CSetting : NSObject <NSCoding>
{
    ...
    unsigned int _m_teenagerModeFinderSetting;
    unsigned int _m_teenagerModeBizAcctSetting;
    unsigned int _m_teenagerModeMiniProgramSetting;
...
- (void).cxx_destruct;
@property(nonatomic) unsigned int m_teenagerModeMiniProgramSetting; // @synthesize m_teenagerModeMiniProgramSetting=_m_teenagerModeMiniProgramSetting;
@property(nonatomic) unsigned int m_teenagerModeBizAcctSetting; // @synthesize m_teenagerModeBizAcctSetting=_m_teenagerModeBizAcctSetting;
@property(nonatomic) unsigned int m_teenagerModeFinderSetting; // @synthesize m_teenagerModeFinderSetting=_m_teenagerModeFinderSetting;
