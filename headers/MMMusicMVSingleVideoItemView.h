...
@class MMMusicFadeOutLayer, MMMusicLiveVideoPlayerView, MMMusicMVTrackItem, NSString, UIImageView;
@protocol MMMusicMVSingleVideoItemViewDelegate;

@interface MMMusicMVSingleVideoItemView : UIView <MMMusicLiveVideoPlayerDelegate>
{
