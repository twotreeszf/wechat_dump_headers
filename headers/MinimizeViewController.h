...
- (void)hideTaskViewsAndShowAdsorbFloatingViewAnimated:(id)arg1 Duration:(double)arg2 exitType:(int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)hideTaskListAndShowAdsorbFloatingViewAnimatedWithExitType:(int)arg1 completion:(CDUnknownBlockType)arg2;
