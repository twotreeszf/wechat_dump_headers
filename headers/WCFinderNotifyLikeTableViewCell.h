...
@class MMWebImageView, NSLayoutConstraint, NSString, RichTextView, UIImageView, UILabel, UIView, WCFinderAggregatedTitleView, WCFinderDynamicIconFetchToken, WCFinderHeadImageView, WCFinderNotifyCenterCellViewModel;

@interface WCFinderNotifyLikeTableViewCell : UITableViewCell <WCFinderHeadImageViewDelegate, WCFinderDynamicFetchIconDelegate>
{
    ...
    WCFinderDynamicIconFetchToken *_likeImageToken;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) WCFinderDynamicIconFetchToken *likeImageToken; // @synthesize likeImageToken=_likeImageToken;
