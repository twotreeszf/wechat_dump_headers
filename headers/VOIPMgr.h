...
@interface VOIPMgr : MMUserService <AVVideoDataSource, AUAudioDataSource, IAUAudioDeviceExt, ISysCallCheckExt, IVOIPSyncExt, PBMessageObserverDelegate, INetworkStatusMgrExt, CNetworkStatusExt, CMobileSIMTypeExt, MMServiceProtocol, AVVideoDeviceSessionDelegate>
{
...
- (basic_string_90719d97)GetCellularIspInfoStr;
