...
@interface BrandProfileBaseTabViewController : UITableViewController <BrandProfileMessageBaseCellDelegate, BrandProfileTipsCellDelegate, MMRefreshTableFooterDelegate, MMImageLoaderObserver>
{
