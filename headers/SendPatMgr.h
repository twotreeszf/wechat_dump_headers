...
@class MMTimer, NSMutableDictionary, NSString, OrderedDictionary, RevokePatReportObject, SendPatToastViewController, SendPatWrap;
...
- (void).cxx_destruct;
@property(retain, nonatomic) MMTimer *delaySendPatTimer; // @synthesize delaySendPatTimer=_delaySendPatTimer;
