...
@class MMUIViewController, NSArray, NSDictionary, NSMutableDictionary, NSNumber, NSString, POIInfo, UIColor, UIImage, UIView, UIViewController, WCAdvertiseInfo, WCCanvasComponent, WCCanvasComponentItem, WCCanvasReportMgr, WCWeAppBizTempSessionInfo;
...
- (void)onPureImageLongPress:(_Bool)arg1 image:(UIImage *)arg2 url:(NSString *)arg3 componentType:(unsigned long long)arg4 qrExtInfo:(NSString *)arg5 scanComplete:(void (^)(_Bool))arg6;
