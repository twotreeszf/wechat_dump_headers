...
@class AVAsset, EditImageAttr, EditVideoAttr, EditVideoInitialView, MMAsset, NSString, UIImage, WCFinderCreateCoordinator;
@protocol EditVideoLogicItemDelegate, EditVideoOptionsDelegate;

@interface EditVideoLogicItem : MMObject <EditVideoInitialViewDelegate, WCEditVideoViewControllerDelegate, WCFinderCreateCoordinatorDelegate>
{
