...
@class MMTagTextField, NSMutableDictionary, NSString, UIImageView, UILabel, UIMonitorCollectionView, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderSearchHistoryListView, WCFinderSearchViewModel, WCFinderStreamFooterView, WCFinderStreamLayout, WCFullScreenTitleView;
