...
@class NSLock, NSMutableArray, NSObject, NSString, NSThread, TXAudioEffectManager, TXBeautyManager, TXC264Tunnel, TXCCameraCapturer, TXCRenderView, TXCVideoEncoder, TXCVideoPreprocessorEx, TXReplayKitMixer, TXSNALPacket, UIImage;
...
@interface TXCCaptureAndEnc : TXCModule <TXIAudioRecordDelegate, TXIAudioEncodeTRAEDataDelegate, TXICameraCapturerDelegate, RPScreenRecorderDelegate, TXC264TunnelDelegate, TXIVideoPreprocessorDelegateEx, TXIVideoEncoderDelegate, TXIRenderViewDelegate, TXINotifyDelegate>
{
    ...
    _Bool _enableHighQualityEncode;
    _Bool _lockOutput;
...
@property(nonatomic) _Bool enableHighQualityEncode; // @synthesize enableHighQualityEncode=_enableHighQualityEncode;
...
- (long long)getAudioInputDeviceVolume;
