...
@class CLLocation, LbsLife, LocationRetriever, MMAutoSearchLogic, MMLocationAccuracyAuthorizationTipView, MMTableView, NSIndexPath, NSMutableArray, NSString, UILabel, UIView, WCDataSearcher, WCTimeLineFooterView, WCUIAlertView;
