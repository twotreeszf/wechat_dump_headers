...
@class FinderStreamLayoutInfo, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCFinderAbstractTask, WCFinderFeedLayoutContentVM;
@protocol WCFinderFeedFollowVMDelegate;

@interface WCFinderFeedFollowVM : NSObject <WCFinderDataItemExt, WCFinderPostingCommentExt, WCFinderRedDotNotifyExt, WCFinderPostDataItemExt, WCFinderStreamPreFetchExt, WCFinderFeedContentVMExt, WCFinderLiveExt>
{
    ...
    _Bool _isRealNoMoreData;
    _Bool _shouldVernierControl;
    ...
    unsigned long long _cursorIndexCount;
    long long _currentIndex;
    long long _descriptionIndex;
    double _fakeLoadingDuration;
...
@property(nonatomic) double fakeLoadingDuration; // @synthesize fakeLoadingDuration=_fakeLoadingDuration;
@property(nonatomic) _Bool shouldVernierControl; // @synthesize shouldVernierControl=_shouldVernierControl;
@property(nonatomic) long long descriptionIndex; // @synthesize descriptionIndex=_descriptionIndex;
@property(nonatomic) long long currentIndex; // @synthesize currentIndex=_currentIndex;
@property(nonatomic) unsigned long long cursorIndexCount; // @synthesize cursorIndexCount=_cursorIndexCount;
@property(nonatomic) _Bool isRealNoMoreData; // @synthesize isRealNoMoreData=_isRealNoMoreData;
...
- (unsigned long long)realSectionNums;
...
- (void)loadingNextPageByFooterFetch;
- (void)changeSectionNumberByPullDown;
...
- (void)clearDataByServerRequestWithStreamDataArray:(id)arg1 historyDataArray:(id)arg2;
