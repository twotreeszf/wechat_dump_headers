...
@class CBaseContact, CContact, CEmoticonWrap, CMessageWrap, LinkWeAppJumpWrap, MMUIViewController, NSArray, NSMutableArray, NSString, PatWrap, PushMailWrap, TranslateInfo, UIView;
