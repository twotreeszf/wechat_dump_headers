...
@class NSMutableArray, NSString, WAAppBrandNotifyInfo, WAPackageDownloadLogic, WAPackageInfoCacheLogic, WAPackageSweeperLogic, WAPublicResInfo, WAPublicResInfoStorage, WAPublicResModel;
...
- (void)subThread_verifyLocalCacheChecksum:(id)arg1 pkgFilePath:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (_Bool)verifyLocalCacheChecksum:(id)arg1 pkgFilePath:(id)arg2;
