...
@interface WCAccountSignHelper : NSObject
{
    ...
    basic_string_90719d97 _privateKeyForECDSA;
}
...
@property(nonatomic) basic_string_90719d97 privateKeyForECDSA; // @synthesize privateKeyForECDSA=_privateKeyForECDSA;
