...
@class NSArray, NSString, NSURLRequest, UIScrollView, YYWKWebViewScriptMessageHandler;
@protocol YYWebViewDelegate;

@interface YYBaseWebView : WKWebView <WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler, YYWebViewInterface>
{
