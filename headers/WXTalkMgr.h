...
@interface WXTalkMgr : MMUserService <AUAudioDataSource, IRemoteControlCheckExt, AVAudioPlayerDelegate, CNetworkStatusExt, IAUAudioDeviceExt, MMServiceProtocol, PBMessageObserverDelegate, IWXTalkPresentExt, IContactMgrExt, IMMNewSessionMgrComparerExt, MMKernelExt>
{
    _Bool _isInTalkRoom;
