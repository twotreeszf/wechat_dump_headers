...
- (void)onOpenSearchGameResultItem:(id)arg1 searchWord:(id)arg2 sourceScene:(long long)arg3;
- (void)handleShowMore:(id)arg1;
- (void)handleSearchWebResultItem:(id)arg1;
- (long long)handleSearchGameResultItem:(id)arg1 searchWord:(id)arg2 sourceScene:(long long)arg3;
...
- (id)initWithContentsController:(id)arg1 isHeaderView:(_Bool)arg2 sourceScene:(long long)arg3;
