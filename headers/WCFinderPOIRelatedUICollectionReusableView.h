...
@class MMUILabel, MMWebImageView, NSString, RichTextView, SnsPoiDetail, UIImageView, UIView, WCFinderContact, WCFinderHeadImageView;
@protocol WCFinderPOIRelatedUICollectionReusableViewDelegate;

@interface WCFinderPOIRelatedUICollectionReusableView : UICollectionReusableView <ILinkEventExt, WCFinderHeadImageViewDelegate>
{
...
+ (double)headerViewHeightWith:(id)arg1 bindContact:(id)arg2 noticeWording:(id)arg3 isDataEmpty:(_Bool)arg4 width:(double)arg5;
- (void).cxx_destruct;
...
- (void)updateWith:(id)arg1 bindContact:(id)arg2 noticeWording:(id)arg3 isDataEmpty:(_Bool)arg4;
