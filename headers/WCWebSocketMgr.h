...
@interface WCWebSocketMgr : MMUserService <MMServiceProtocol>
{
    ...
    struct map<std::__1::basic_string<char>, WssCallback *, std::__1::less<std::__1::basic_string<char>>, std::__1::allocator<std::__1::pair<const std::__1::basic_string<char>, WssCallback *>>> callbackMap;
}
