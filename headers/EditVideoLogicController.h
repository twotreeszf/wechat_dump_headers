...
+ (void)reportVideoCompressionInfoWithOutputPath:(id)arg1 inputPath:(id)arg2 videoTrack:(id)arg3 audioTrack:(id)arg4 compressionTime:(double)arg5 params:(id)arg6 entranceType:(unsigned long long)arg7;
...
+ (void)checkUseSWTranscoding:(unsigned long long)arg1 withAttr:(id)arg2 pathNum:(unsigned long long)arg3 assetsNum:(unsigned long long)arg4 VideoEncodeParams:(id)arg5;
