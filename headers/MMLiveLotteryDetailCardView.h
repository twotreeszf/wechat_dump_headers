...
@class MMFinderLiveLotteryDisplayLogic, MMFinderLiveLotteryInfo, MMFinderLiveTaskId, MMHeadImageView, MMLiveLotteryWinnerRecordListView, MMUIButton, UIImage, UIImageView, UILabel;
