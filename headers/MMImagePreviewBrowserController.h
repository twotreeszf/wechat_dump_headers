...
@class EditImageIntialView, EditVideoLogicItem, MMAsset, MMAssetPickerSendButton, MMAssetSelectCheckButton, MMAssetSelectedCollectionView, MMUIActivityIndicatorView, MultiImageScrollView, NSMutableDictionary, NSString, UIButton, UIImageView, UILabel, UIView, WCFinderCreateCoordinator;
@protocol MMImagePickerControlCenter, MMImagePreviewBrowserControllerDataSource, MMImagePreviewBrowserControllerDelegate;

@interface MMImagePreviewBrowserController : WCDragToCloseViewController <EditVideoLogicItemDelegate, WCEditVideoViewControllerDelegate, WCFinderLongVideoChooseHelperContextProtocol, EditImageInitialViewDelegate, WCEditImageViewControllerDelegate, WCFinderPostViewControllerDelegate, WCFinderCreateCoordinatorDelegate, MMAssetPickerBrowserViewDelegate, MMAssetSelectedCollectionViewDelegate, SightLocalVideoProcessingViewControllerDelegate, MultiImageScrollViewDelegate, WCActionSheetDelegate>
{
...
- (id)init;
- (void)onWCEditVideoViewControllerDidCancel;
- (void)editVideoViewController:(id)arg1 subEditor:(id)arg2 didFinishEditingVideo:(id)arg3 andForceChangeToScene:(unsigned int)arg4;
- (void)returnToTimelineOrAlbum;
- (void)editVideoViewControllerDidCancel:(id)arg1;
- (void)editVideoViewController:(id)arg1 didFinishEditingVideo:(id)arg2;
- (void)editVideoLogicItem:(id)arg1 subEditor:(id)arg2 didFinishEditingVideo:(id)arg3;
...
- (void)handleFinishEditingVideo:(id)arg1 editor:(id)arg2 subEditor:(id)arg3;
