...
@property(readonly, nonatomic) double fTargetRate; // @synthesize fTargetRate=_fTargetRate;
...
- (_Bool)hasOCR:(id)arg1;
- (_Bool)hasTranslate:(id)arg1;
- (_Bool)shouldShowOCREntry:(id)arg1;
- (_Bool)shouldShowTranslateEntry:(id)arg1 leastContentRate:(double)arg2;
- (void)dealloc;
