...
@class MMLiveCDNPlayerView, NSString, UILabel, UIView, WCFinderDataItem, WCFinderLiveNowView;
...
- (void)updateDataSourceWithDataItem:(id)arg1 style:(unsigned long long)arg2;
