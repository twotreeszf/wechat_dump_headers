...
- (union MapVector2d *)createPoint:(id)arg1 count:(int)arg2;
...
- (void)updatePolyline:(id)arg1 linePayload:(id)arg2 isTexture:(_Bool)arg3;
...
- (void)removeMarker:(int)arg1;
- (int)AddMarker:(struct MapMarkerIconInfo *)arg1;
