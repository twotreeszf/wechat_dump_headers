...
@interface TextFloatViewController : MMUIViewController <TransitioningAnimationDelegate, MMRTCMenuResponderDelegate, MMTextFloatBottomToolViewDelegate, MMRTCMenuEventDelegate, WAAppContactPreLoaderProtocol, ILinkEventExt, scrollViewDelegate, MMRichTextSelectEventDelegate>
{
    UIView *m_oBackView;
    UIButton *m_view;
