...
@class CContact, MMTimer, MultiTalkBeforeTalkingOperateView, MultiTalkBottomOperatePanel, MultiTalkContactsCollectionView, MultitalkSecondOperateView, NSArray, NSDictionary, NSString, UIImageView, WCUIAlertView;
