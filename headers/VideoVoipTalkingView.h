...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, AVSampleBufferDisplayLayer, CAGradientLayer, CContact, MMHDHeadImageView, MMTimerLabel, NSString, SmallCameraView, UIButton, UIImageView, UILabel, UIView, VOIPVideoRender, VOIPVideoToVoiceView, VoipDescriptionButton;
...
- (void)updateInitMode:(_Bool)arg1 initMuteModeOpen:(_Bool)arg2;
