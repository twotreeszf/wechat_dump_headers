...
@class NSArray, NSDictionary, NSString, UIView, UIViewController, WAAppTaskExtInfo, WAGameExtraInfo, WAPermissionResult, WATransferJSAPIRuntimeModel, WAWebViewController;
