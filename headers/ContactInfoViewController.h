...
@class BrandProfileEnterInfo, CBaseContactInfoAssist, CContact, CContactVerifyLogic, CMessageWrap, ForwardMessageLogicController, MMUIButton, MMUILabel, MMUIView, NSMutableDictionary, NSString, SendVerifyMsgLogicController, TextStateDetailContentView, TextStateProfileDragAnimateHelper, UIButton, UITableView, WCStoryDataItem, WCStoryDragAnimationUtil, WCStorysPreviewViewController;
@protocol ContactInfoViewControllerDelegate, contactInfoDelegate;

@interface ContactInfoViewController : MMUIViewController <ForwardMessageLogicDelegate, WCStorysPreviewViewControllerDelegate, WCStoryFacadeExt, IExtraDeviceLoginMgrExt, SendVerifyMsgViewControllerDelegate, WeixinContactInfoAssistDelegate, TextStateMgrExt, PBMessageObserverDelegate, ContactInfoAssistDelegate, IContactMgrExt, VerifyPhoneDelegate, MMSayHelloViewControllerDelegate, ICertInfoMgrExt, WCFacadeExt, IStrangerContactMgrExt, IUpdateProfileMgrExt, IHDHeadImageViewExt>
{
...
- (void)onTextStateDetailContentViewGenerated:(id)arg1;
