...
@class MMImageScrollViewHelper, MMLoadingView, MMProgressViewEx, MMUIButton, NSArray, NSString, OCRTransHalfScreenViewController, ScanQRCodeLogicController, UIImage, UIImageView, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic, WCMediaItem, WCMediaItemWrap, WXFullScreenGestureRecognizer;
@protocol WCImageFullScreenViewContainerDelegate;

@interface WCImageFullScreenViewContainer : MMUIScrollView <WCActionSheetDelegate, BaseScanLogicDelegate, FullScreenGestureDelegate, WCImageTranslateDelegate, MMUIHalfScreenViewControllerDelegate, UIScrollViewDelegate, MMImageScrollViewHelperDelegate, WCFacadeExt>
{
