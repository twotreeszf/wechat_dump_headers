...
@class NSString, UICollectionView, UILabel, WCFinderAnimationLoadingView, WCFinderStreamFooterView, WCFinderStreamMusicViewModel, WCFinderStreamProfilePage;
@protocol UICollectionViewDelegate><UICollectionViewDataSource><WCFinderStreamLayoutDelegate;

@interface WCFinderStreamProfileMusicController : NSObject <UICollectionViewDelegate, UICollectionViewDataSource, WCFinderStreamLayoutDelegate, WCFinderStreamProfilePageDelegate, WCFinderStreamMusicViewModelDelegate, WCFinderStreamFooterViewActionDelegate, WCFinderProfileMusicViewDelegate>
{
    UICollectionView *_collectionView;
    WCFinderStreamMusicViewModel *_viewModel;
...
@property(retain, nonatomic) WCFinderStreamMusicViewModel *viewModel; // @synthesize viewModel=_viewModel;
...
- (void)viewModel:(id)arg1 appendDataFrom:(long long)arg2 toIdx:(long long)arg3;
