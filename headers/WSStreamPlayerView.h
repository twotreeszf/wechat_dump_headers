...
@class CAGradientLayer, HttpVideoStreamPlayerView, MMProgressViewEx, MMUIImageView, MMUILabel, NSMutableArray, NSString, UIButton, UIImageView, WAScreenBrightnessStateView, WCNetworkMediaSlider, WSPlayerMaskView, WSPlayerSimpleProgressBar, WSStreamDotAttachView, WSVideoModel, WSVideoOperateButton, WSVideoPlayStat, WSVideoPullRecommendStreamLogic, WSVideoSourceView;
