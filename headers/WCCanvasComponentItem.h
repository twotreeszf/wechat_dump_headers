...
- (id)fetchTransitionColorForTwistAnimation;
- (id)fetchTransitionImgForTwistAnimation;
- (_Bool)canShowTwistAnimation;
- (_Bool)updateRandomLayoutWithChosenCardId:(id)arg1;
