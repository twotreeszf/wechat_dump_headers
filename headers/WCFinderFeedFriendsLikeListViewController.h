...
#import "WCFinderWeChatRefuseLikeListCenterViewControllerDelegate-Protocol.h"

@class MMTableView, MMUIButton, NSString, UILabel, UINavigationController, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderFeedFriendsLikeListViewModel, WCFinderRefreshTableFooterView;
@protocol WCFinderFeedFriendsLikeListViewControllerDelegate;

@interface WCFinderFeedFriendsLikeListViewController : MMUIHalfScreenViewController <UITableViewDataSource, UITableViewDelegate, WCFinderFeedFriendsLikeListViewModelDelegate, WCFinderRefreshTableFooterViewDelegate, WCFinderFeedFriendsLikeListTableViewCellDelegate, WCFinderFeedFriendsLikeGuideViewControllerDelegate, WCFinderWeChatRefuseLikeListCenterViewControllerDelegate, MMUIHalfScreenViewControllerDelegate, WCFinderRefuseLikeListViewControllerDelegate>
{
...
- (void)onClickLikedListBtnWithUsername:(id)arg1;
...
- (void)setupTitleLabelText:(unsigned long long)arg1;
