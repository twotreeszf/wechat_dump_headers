...
- (_Bool)matchContent:(id)arg1 aggregate:(struct KeywordsAggregate)arg2;
- (struct KeywordHashPair)getHashPairWithHash1:(unsigned short)arg1 Hash2:(unsigned short)arg2;
- (struct KeywordsAggregate)getKeywordsAggregate:(unsigned char)arg1 Hash1:(unsigned short)arg2 Hash2:(unsigned short)arg3;
