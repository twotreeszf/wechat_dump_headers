...
- (void)doPrefetchWebResIfNeedForUrl:(id)arg1 extInfo:(id)arg2 scene:(unsigned int)arg3 canRedirect:(_Bool)arg4 httpHeader:(id)arg5 config:(id)arg6;
...
- (void)prefetchWebResIfNeedForUrl:(id)arg1 extInfo:(id)arg2 scene:(unsigned int)arg3 canRedirect:(_Bool)arg4 httpHeader:(id)arg5;
