...
- (void)markReadTid:(id)arg1 markReadScene:(unsigned long long)arg2 subScene:(unsigned long long)arg3 commentScene:(unsigned long long)arg4 duration:(unsigned long long)arg5;
...
- (void)markReadTid:(id)arg1 markReadScene:(unsigned long long)arg2 commentScene:(unsigned long long)arg3 duration:(long long)arg4;
