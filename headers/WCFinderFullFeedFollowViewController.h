...
@class MMScrollViewProxy, MMTipsViewController, MMUIButton, MMUISearchBar, NSIndexPath, NSMutableDictionary, NSString, UIImageView, UILabel, UIMonitorTableView, UITapGestureRecognizer, UIView, UIViewController, WCActionSheet, WCFinderFeedContentVM, WCFinderFeedDescriptionTableViewCell, WCFinderFeedFollowVM, WCFinderFriendLiveSectionTableViewCell, WCFinderPullDownRefreshHeaderView, WCFinderRefreshTableFooterView;
