...
@class EditImageCropGridView, EditImageCropOverlayView, EditImageCropToolBarView, EditImageEmotionToolAttrView, EditImageMosaicToolAttrView, EditImagePenToolAttrView, EditImageTextToolV2, EditVideoBGMView, EditVideoMusicController, MMTimer, MMUIImageView, NSMutableArray, NSMutableDictionary, NSString, RecommendedMusicInfo, UIButton, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UIView, WCEditFilterToolAttrView, WCEditImageScrollView, WCEditSelectedCollectionView, WCFinderEditImageMusicView;
...
- (id)cropImage:(id)arg1 cropRect:(struct CGRect)arg2 assetPreviewImageViewSize:(struct CGSize)arg3;
