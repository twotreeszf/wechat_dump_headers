...
@optional
- (void)easterEggEnd:(_Bool)arg1;
- (void)easterEggTapInteractiveImplicitView:(InteractiveImplicitView *)arg1;
- (void)easterEggStartWithKeyword:(NSString *)arg1;
- (void)easterEggTriggerWithKeywords:(NSString *)arg1;
@end
