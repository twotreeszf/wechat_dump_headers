...
@protocol WAStarCollectionViewCellDelegate;

@interface WAStarCollectionViewCell : UICollectionViewCell <MMWebImageViewDelegate>
{
    _Bool _isInEdit;
    _Bool _needTitleAlpha;
    unsigned int _state;
    NSString *_appid;
    NSString *_iconUrl;
    NSString *_title;
    id <WAStarCollectionViewCellDelegate> _delegate;
...
@property(nonatomic) __weak id <WAStarCollectionViewCellDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) _Bool needTitleAlpha; // @synthesize needTitleAlpha=_needTitleAlpha;
