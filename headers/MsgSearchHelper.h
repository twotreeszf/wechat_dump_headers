...
@class FTSMessageDB, FTSMsgSearchTask, MMLoadingView, MMUILabel, MMUIViewController, NSMutableArray, NSString, SGCustomButton, UIButton, UITextField, UIView, WCDataSearcher;
