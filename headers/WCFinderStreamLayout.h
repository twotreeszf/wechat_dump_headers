...
@protocol WCFinderStreamLayoutDelegate;

@interface WCFinderStreamLayout : UICollectionViewLayout
{
    id <WCFinderStreamLayoutDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderStreamLayoutDelegate> delegate; // @synthesize delegate=_delegate;
