...
@class FinderNicknameVerifyInfo, MMGrowTextView, MMUIButton, NSMutableArray, NSString, RichTextView, UIButton, UIImage, UIImageView, UILabel, UIScrollView, UISwitch, UIView, WCFinderBannerView, WCFinderContact, WCFinderCreateUserViewModel, WCFinderGetWechatHDHeadFetcher;
@protocol WCFinderCreateUserViewControllerDelegate;

@interface WCFinderCreateUserViewController : MMUIViewController <MMImagePickerManagerDelegate, UITextViewDelegate, MMGrowTextViewDelegate, WCFinderVeirfyNameTipsViewControllerDelegate, WCFinderBannerViewDelegate, MMRegionPickerViewControllerDelegate, ILinkEventExt, MMImageCropperDelegate>
{
...
@property(nonatomic) long long createScene; // @synthesize createScene=_createScene;
