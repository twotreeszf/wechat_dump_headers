...
@class BaseResponse, DocumentItem, FinancialInfo, LQTDetailButton, LctOperationInfo, LqtDialog, MiniAppsItem, NSMutableArray, NSString, NewDocumentItem, PopUpsItem;
