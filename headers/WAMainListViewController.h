...
@class MMTableView, MMToastViewController, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIPercentDrivenInteractiveTransition, UISearchBar, UIView, UIViewController, WAAppItemData, WAMainListNearByLogic, WAMainListPageLogic, WAMainListStarLogic, WAPackageSweeperLogic, WASearchController;
