...
@interface MPPageFastLoadMgr : MMUserService <PBMessageObserverDelegate, MMServiceProtocol>
{
...
- (void)lauchVideoPrefetchTaskWithUrl:(id)arg1 Scene:(unsigned int)arg2;
