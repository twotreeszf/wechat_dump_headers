...
@class MMScrollActionSheetContainerView, MMUILabel, MMWebImageView, NSArray, NSMutableArray, NSString, UIButton, UIColor, UIImage, UIImageView, UIViewController, WCTagsView;
@protocol IWCRichTextLabelProtocol, IWCUIKitRichTextProxyService, MMScrollActionSheetDelegate;

@interface MMScrollActionSheet : UIView <MMScrollActionSheetItemViewDelegate, IUiUtilExt, UIScrollViewDelegate, UIPopoverPresentationControllerDelegate, MMActionSheetScrollViewDelegate, IWCRichTextLabelDelegate>
{
    _Bool _moveRight;
