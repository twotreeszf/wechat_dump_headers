...
@class ChatRoomHistoryShareStat, ContactSelectToolView, ContactSelectView, NSArray, NSDictionary, NSIndexPath, NSMutableArray, NSMutableDictionary, NSString, NewContactsSearchPanelView, TipsView, UIBarButtonItem, UIButton, UIView;
