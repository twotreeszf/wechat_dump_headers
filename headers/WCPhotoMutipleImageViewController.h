...
@class CContact, ForwardMessageLogicController, MMAnimationTipView, MMHeadImageView, MMScrollView, NSMutableArray, NSMutableSet, NSString, OCRTransHalfScreenViewController, RichTextView, ScanQRCodeLogicController, ShareDataToOpenSDKController, UIButton, UIImageView, UILabel, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic, WCLikeButton;
