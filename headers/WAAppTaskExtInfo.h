...
@class NSMutableDictionary, NSString, WAAppTaskReferrerInfo, WAAppTaskTransitInfo, WAAppTaskWebLaunchInfo, WAApptaskPluginResInfo, WAPageFlowAppInfo, WAPageFlowSessionInfo, WAUINavigationController;
