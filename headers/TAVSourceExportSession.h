...
- (_Bool)hasVideoInAsset;
- (_Bool)hasAudioInAsset;
- (void)applicationDidBecomeActiveNotification;
- (void)applicationWillResignActiveNotification;
- (void)removeNotification;
- (void)setupNotification;
- (_Bool)setupAudioInputWithError:(id *)arg1;
- (_Bool)setupAudioOutputWithError:(id *)arg1;
- (_Bool)setupVideoInputWithError:(id *)arg1;
- (_Bool)setupVideoOutputWithError:(id *)arg1;
- (id)buildDefaultVideoComposition;
- (_Bool)setupAudioInputOutputWithError:(id *)arg1;
- (_Bool)setupVideoInputOutputWithError:(id *)arg1;
