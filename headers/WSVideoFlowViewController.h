...
@class ForwardMessageLogicController, MMUILabel, NSString, UIImageView, UIView, WCTimeLineFooterView, WSFullVideoDragEducateView, WSVideoFlowTableViewCell, WSVideoFullScreenController, WSVideoModel, WSVideoTagInfo;

@interface WSVideoFlowViewController : WSVideoFlowBaseViewController <WSVideoFlowDataDelegate, UITableViewDelegate, UITableViewDataSource, tableViewDelegate, WSVideoFlowTableViewCellDelegate, MMRefreshTableFooterDelegate, UIViewControllerAnimatedTransitioning, WSVideoPlayerViewDelegate, WSFullVideoDragEducateViewDelegate, ITopStoryPluginMsgExt, WSVideoWowEducateDelegate>
{
    UIView *_navBarBkg;
    UIView *_headerView;
    ...
    WSVideoFlowTableViewCell *_goodLookInteractiveCell;
    struct CGSize _lastViewSize;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WSVideoFlowTableViewCell *goodLookInteractiveCell; // @synthesize goodLookInteractiveCell=_goodLookInteractiveCell;
