...
@class GetBalanceMenuResponse, NSDictionary, NSString, RichTextView, TimeoutNumber, UIButton, UIImageView, UILabel, UIView, WCActionSheet, WCPayGetBalanceMenuCgi, WCPayNoticeBanner, WCPayWebImageView;
...
@property(retain) UIButton *upgradeButton; // @synthesize upgradeButton=_upgradeButton;
@property(retain) UIButton *qaButton; // @synthesize qaButton=_qaButton;
...
@property(retain) UIButton *lqtEntryButton; // @synthesize lqtEntryButton=_lqtEntryButton;
