...
@class NSString, WCAdDislikeReason, WCDataItem;

@protocol WCAdvertiseFeedbackViewDelegate <NSObject>
- (void)onClickNegativeReasonBtn:(WCAdDislikeReason *)arg1 dataItem:(WCDataItem *)arg2;
- (void)onClickNegativeBtn:(_Bool)arg1 dataItem:(WCDataItem *)arg2;
- (void)onClickPositionBtn:(WCDataItem *)arg1;
