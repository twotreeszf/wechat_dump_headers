...
- (void)internalSenddRequest:(id)arg1 md5:(id)arg2 data:(id)arg3 scene:(unsigned int)arg4 coreId:(unsigned int)arg5 debugMode:(unsigned long long)arg6;
- (void)sendRequest:(id)arg1 data:(id)arg2 scene:(unsigned int)arg3 shouldUseCache:(_Bool)arg4 coreId:(unsigned int)arg5 debugMode:(unsigned long long)arg6;
