...
@class AppMessageBlockButton, CADisplayLink, CTRichTextView, CommonMessageCellViewExtTarget, CommonMessageViewModel, MMCPLabel, MMHeadImageView, MMUIActivityIndicatorView, NSString, TextStateItemView, UIButton, UIImageView, UILabel, UIView, WCChatRoomStoryDataVM, YYAsyncImageView;

@interface CommonMessageCellView : BaseMessageCellView <IAppDataExt, IContactMgrExt, IStrangerContactMgrExt, IKFContactExt, WCActionSheetDelegate, CommonMessageCellViewExtTargetDelegate>
{
