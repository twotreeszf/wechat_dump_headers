...
@class NSMutableArray, NSString, TXAudioEffectManager, TXCCaptureAndEnc, TXCDataReport, TXCQoS, TXCStreamUploader, TXLivePushConfig, UITextView, UIView;
@protocol OS_dispatch_source, TXAudioCustomProcessDelegate, TXLivePushListener, TXVideoCustomProcessDelegate;

@interface TXLivePush : NSObject <TXINotifyDelegate, TXICustomPreprocessDelegate, TXICaptureAndEncDelegate, TXIUploaderDelegate, TXIQoSDelegate, TXBeautyManagerTraitControl, TXCAudioEventDelegate>
{
    int _videoQuality;
    NSString *_rtmpURL;
