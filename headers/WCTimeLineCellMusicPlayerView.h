...
@class CAGradientLayer, MMMusicPlayerContoller, MMMusicRhythmBackgroundView, MMWebImageView, NSString, UIImageView, UILabel, UIViewPropertyAnimator, UIVisualEffectView, WCDataItem;
