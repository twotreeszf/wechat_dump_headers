...
@interface YtActReflectReqData : NSObject
{
    ...
    struct TC_FaceShape _bestShape;
    struct TC_FaceShape _eyeShape;
    struct TC_FaceShape _mouthShape;
...
@property struct TC_FaceShape mouthShape; // @synthesize mouthShape=_mouthShape;
@property struct Mat mouthImg; // @synthesize mouthImg=_mouthImg;
@property struct TC_FaceShape eyeShape; // @synthesize eyeShape=_eyeShape;
@property struct Mat eyeImg; // @synthesize eyeImg=_eyeImg;
@property struct TC_FaceShape bestShape; // @synthesize bestShape=_bestShape;
