...
@interface MMMoviePlayerController : WCDragToCloseViewController <FullScreenGestureDelegate, WCPlayerConfigDelegate, WCActionSheetDelegate, IMsgExt, scrollViewDelegate, WindowDelegate, SessionSelectControllerDelegate, IMsgRevokeExt>
{
    NSURL *m_url;
