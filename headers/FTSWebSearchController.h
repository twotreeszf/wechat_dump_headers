...
@interface FTSWebSearchController : NSObject <UISearchBarDelegate, UIScrollViewDelegate, FTSWebSearchDataSource, WSJSEventHandleDelegate, WSContactSearchLogicDelegate, WSTagSearchDelegate, WASearchFromGlobalProxyDelegate, WAAppCanvasWrapperViewDelegate, IWSViewControllerLifeCycleExt, EmoticonBoardViewDelegate, BaseEmoticonViewDelegate>
{
...
- (void)dealloc;
- (id)initWithViewController:(id)arg1 Scene:(int)arg2 mode:(int)arg3 businessType:(unsigned long long)arg4 query:(id)arg5;
- (id)init;
