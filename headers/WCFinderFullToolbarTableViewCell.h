...
@protocol WCFinderFullToolbarTableViewCellDelegate;

@interface WCFinderFullToolbarTableViewCell : UITableViewCell <WCFinderFeedToolbarActionDelegate, WCFinderFeedRetryToolBarDelegate, WCFinderFeedUploadingToolBarDelegate, WCFinderFeedContentVMExt, WCFinderFeedNotRealNameToolbarViewDelegate>
{
    unsigned long long _contentStatus;
    id <WCFinderFullToolbarTableViewCellDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderFullToolbarTableViewCellDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)showGroupLikeActionSheet;
- (void)didClickShareAction;
