...
@class AVAudioPlayer, AVVideoDevice, MMTimer, MinimizeTaskData, MultiTalkMainViewController, MultiTalkWindow, MultitalkMinimizeView, MultitalkMinimizeWindow, NSMutableArray, NSMutableDictionary, NSString, SafeMutableDictionary, VoipCheckAudioDeviceObj;
...
@property(nonatomic) NSString *lastSubscribeScreenUserName; // @synthesize lastSubscribeScreenUserName=_lastSubscribeScreenUserName;
