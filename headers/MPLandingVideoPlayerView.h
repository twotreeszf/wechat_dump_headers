...
#import "MPLandingVideoOptionsPannelDelegate-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class CALayer, MMTimer, MMUIButton, MMUIImageView, MMUILabel, MMWebImageView, MMWebViewController, MPLandingVideoDotAdWebViewPosInfo, MPLandingVideoErrView, MPLandingVideoOptionsPanelView, MPPlayerHttpMediaWrap, NSDictionary, NSMutableArray, NSString, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UISlider, UITapGestureRecognizer, UITopTouchView, UIView, UIViewController, WAScreenBrightnessStateView, WCNetworkMediaSlider, WCPlayerPlayArgs, WCPlayerView;
@protocol MPLandingVideoPlayerViewDelegate;

@interface MPLandingVideoPlayerView : WCPlayerControlView <UIGestureRecognizerDelegate, MPLandingVideoErrViewDelegate, MMWebImageViewDelegate, MPLandingVideoOptionsPannelDelegate>
{
    ...
    unsigned long long _videoProcessState;
    ...
    MPLandingVideoOptionsPanelView *_definitionPanelView;
    ...
    MMUIButton *_openProfileBtn;
    MMUIButton *_playRateBtn;
    NSDictionary *_playRateDict;
    double _currentPlayRate;
    MPLandingVideoOptionsPanelView *_playRatePanelView;
...
- (void).cxx_destruct;
@property(retain, nonatomic) MPLandingVideoOptionsPanelView *playRatePanelView; // @synthesize playRatePanelView=_playRatePanelView;
@property(nonatomic) double currentPlayRate; // @synthesize currentPlayRate=_currentPlayRate;
@property(retain, nonatomic) NSDictionary *playRateDict; // @synthesize playRateDict=_playRateDict;
@property(retain, nonatomic) MMUIButton *playRateBtn; // @synthesize playRateBtn=_playRateBtn;
@property(retain, nonatomic) MMUIButton *openProfileBtn; // @synthesize openProfileBtn=_openProfileBtn;
...
@property(retain, nonatomic) MPLandingVideoOptionsPanelView *definitionPanelView; // @synthesize definitionPanelView=_definitionPanelView;
...
@property(nonatomic) unsigned long long videoProcessState; // @synthesize videoProcessState=_videoProcessState;
...
@property(nonatomic) _Bool isShowingBackAdWebView; // @synthesize isShowingBackAdWebView=_isShowingBackAdWebView;
...
- (void)onSelectedOption:(id)arg1 panelView:(id)arg2;
- (void)onClickToChangePlayRate:(id)arg1;
- (void)showPlayRatePanel;
- (void)onClickPlayRateBtn;
- (void)initPlayRateBtnIfNeed;
...
- (void)setPreloadSec:(double)arg1;
- (void)setBufferMinLength:(double)arg1 maxLength:(double)arg2;
- (void)setDownloadGrading:(double)arg1;
...
- (void)onVideoDidEndExitFullScreen;
...
- (void)onVideoDidEndEnterFullScreen;
...
- (_Bool)canShowOverViewType:(unsigned long long)arg1;
- (void)onOverViewType:(unsigned long long)arg1 newVisiblity:(_Bool)arg2;
...
- (void)onClickOpenProfileBtnInFullScreen:(id)arg1;
