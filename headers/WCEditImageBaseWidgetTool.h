...
@protocol WCEditImageBaseWidgetToolDelegate;

@interface WCEditImageBaseWidgetTool : EditImageUIView <UIGestureRecognizerDelegate>
{
    ...
    id <WCEditImageBaseWidgetToolDelegate> _delegate;
...
@property(nonatomic) id <WCEditImageBaseWidgetToolDelegate> _delegate; // @synthesize _delegate;
- (void)dealloc;
