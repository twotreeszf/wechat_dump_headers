...
@class EditImageAttr, EditImageIntialView, EditVideoAttr, EditVideoBGMPlayer, EditVideoLogicItem, MMCircularProgressView, MMImageCropperViewController, MMLoadingView, MMShortVideoParamModel, MMSightRecordView, MMUIButton, NSMutableArray, NSString, RecommendedMusicInfo, ShortVideoToolbarPreviewView, SightCameraPreviewView, SightCameraTopToolView, SightSegmentProgressView, SightShootingModeSwitchView, UIButton, UIImage, UIImageView, UILabel, UIView, WCUIAlertView;
@protocol ShortVideoBarDelegate;

@interface ShortVideoToolbar : MMUIView <MonoServiceLogicExt, EditVideoLogicItemDelegate, MMImageCropperDelegate, WCEditVideoViewControllerDelegate, WCEditImageViewControllerDelegate, SightCameraCaptureExt, SightSegmentProgressViewDelegate, SightShootingModeSwitchViewDelegate, EditVideoBGMPlayerDelegate, UITextFieldDelegate, EditImageInitialViewDelegate>
{
    _Bool m_isActive;
    double m_topPositon;
...
@property(retain, nonatomic) MMUIView *beautySelectedView; // @synthesize beautySelectedView=_beautySelectedView;
