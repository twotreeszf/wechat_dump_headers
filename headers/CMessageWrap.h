...
@class AppInnerJumpItem, AppMMScheduleItem, AppMsgShareItem, AppProductItem, AppTVItem, BrandMpVideoItem, CContact, CardTicketItem, EmoticonAppMsgItem, EmoticonSharedItem, EmotionDesignerSharedItem, EmotionPageSharedItem, FavoritesItem, GameLifeItem, GameShareNameCard, GiftCardItem, HardWareItem, ImageInfo, LiteAppSharedItem, MMAsset, MMLiveAppMsgInnerItem, MMMusicShareItem, MMReaderInfo, MMTemplateMsg3rdAppShowItem, MallProductItem, MessageExpItem, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSString, OpenSDKAppBrandItem, PatMessageWrap, PushMailWrap, ScanCodeHistoryItem, VideoUploadStatInfo, WAAppMsgItem, WCCanvasPageItem, WCFinderContentColumnSharedItem, WCFinderLiveShareItem, WCFinderMessageShareNameCard, WCFinderMessageVerifyItem, WCFinderShareItemContainer, WCFinderShareToMomentsItem, WCFinderTopicShareItem, WCMegaVideoShareItem, WCPayExtensionInfo, WCPayInfoItem, WCPayThirdInfo, WSVideoModel, iWatchAppMsgItem;
...
- (_Bool)bIsFinderLiveConnectInviteShareContent;
