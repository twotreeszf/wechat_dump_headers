...
@class MMTableView, NSMutableArray, NSString, TimeoutNumber, UIImageView, WCPayLQTTipsPanelView;
...
- (void)makeLctOperationV2ContentWithProductList:(id)arg1 logo:(id)arg2 arrow:(id)arg3;
- (void)makeLctOperationV2ContentWithoutProductList:(id)arg1 logo:(id)arg2 arrow:(id)arg3;
