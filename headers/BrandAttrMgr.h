...
@interface BrandAttrMgr : MMUserService <IContactMgrExt, WCPayGetCollAssistMenuCgiDelegate, MMServiceProtocol, PBMessageObserverDelegate, IMsgExt, MMConfigMgrExt>
{
...
- (_Bool)fetchProfileNextPkg:(id)arg1 bizSessionID:(unsigned int)arg2 scene:(unsigned int)arg3 action:(int)arg4 offset:(id)arg5 userInfo:(id)arg6;
