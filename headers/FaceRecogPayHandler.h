...
@class FaceRecogPayBaseHandler, FaceRecogPayContractViewController, MMUIViewController, NSString;
@protocol FaceRecogPayHandlerDelegate;

@interface FaceRecogPayHandler : NSObject <FaceRecogBaseHandlerDelegate, FaceRecogHandlerDelegate, PBMessageObserverDelegate, FaceRecogPayContractViewControllerDelegate>
{
    _Bool _m_isKinda;
...
- (void)startContractWithSigned:(_Bool)arg1 contactHint:(id)arg2 contractUrl:(id)arg3;
