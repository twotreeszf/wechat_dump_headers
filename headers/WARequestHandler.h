...
- (id)getNewRequestTask:(id)arg1 isUseCronet:(_Bool)arg2 useQuic:(_Bool)arg3 useHttp2:(_Bool)arg4 useCache:(_Bool)arg5 appType:(unsigned int)arg6;
- (_Bool)isExceedMaxTaskCount;
- (void)invalidate;
- (_Bool)abortRequestTask:(id)arg1 getError:(id *)arg2;
- (void)startRequestTaskWithURL:(id)arg1 taskID:(id)arg2 data:(id)arg3 httpHeaders:(id)arg4 method:(id)arg5 isIgnoreCheckDomain:(_Bool)arg6 context:(id)arg7 completionHandler:(CDUnknownBlockType)arg8 isUseCronet:(_Bool)arg9 useQuic:(_Bool)arg10 useHttp2:(_Bool)arg11 useCache:(_Bool)arg12 appType:(unsigned int)arg13;
- (void)dealloc;
