...
#import "WCDiskIOStackCollectorDelegate-Protocol.h"
#import "WCPowerConsumeStackCollectorDelegate-Protocol.h"

@class NSString, NSThread, WCBlockMonitorConfigHandler, WCCPUHandler, WCDiskIOStackCollector, WCFilterStackHandler, WCMainThreadHandler, WCPowerConsumeStackCollector;
@protocol OS_dispatch_queue, WCBlockMonitorDelegate;

@interface WCBlockMonitorMgr : NSObject <WCPowerConsumeStackCollectorDelegate, WCDiskIOStackCollectorDelegate>
{
    ...
    WCDiskIOStackCollector *m_diskIOStackCollector;
...
- (void)diskIORepeatStackReport;
- (void)diskIOStackCollector:(id)arg1 customInfo:(id)arg2;
