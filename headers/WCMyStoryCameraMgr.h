...
@interface WCMyStoryCameraMgr : MMUserService <MMUIViewControllerExt, MMImagePickerManagerDelegate, WCStoryNewVideoEditViewControllerDelegate, MMSightCameraViewControllerDelegate, MMServiceProtocol>
{
...
- (void)storyVideoEditDidClickDone:(id)arg1 videoPath:(id)arg2 thumbImg:(id)arg3 editVideoAttr:(id)arg4 originImageMd5Str:(id)arg5;
