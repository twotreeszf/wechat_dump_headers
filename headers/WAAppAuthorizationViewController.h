...
@interface WAAppAuthorizationViewController : MMUIViewController <WAAppDetailInfoManagerExtension, MMTipsViewControllerDelegate, WAAppAuthorizationDetailViewControllerDelegate, IMMTemplateMsgAuthServiceExt, WAFavMsgManagerExt>
{
    NSString *m_appid;
...
- (void)onSwitchFavWeAppMsgCell:(id)arg1;
