...
@class EmoticonUploader, FIFOFileQueue, FileQueue, MessageCommonUploader, MsgDataDownloadLogic, NSString, OpenInfo;
@protocol OpenUploadMgrDelegate;

@interface OpenUploadMgr : MMObject <MsgDataDownloadDelegate, MessageCommonUploaderDelegate, EmoticonUploaderDelegate, PBMessageObserverDelegate>
{
