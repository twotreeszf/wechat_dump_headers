...
@class FaceRecogBaseViewController, FaceRecogConfigLogic, FaceRecogReporter, FaceRecogUploadLogic, MMUIViewController, NSString;
@protocol FaceRecogBaseHandlerDelegate, FaceRecogHandlerDelegate;

@interface FaceRecogBaseHandler : MMObject <MonoServiceLogicExt, ISysCallCheckExt, FaceRecogUploadLogicDelegate, FaceRecogConfigLogicDelegate, FaceRecogBaseHandlerDelegate, FaceRecogBaseViewDelegate>
{
    _Bool _needGuide;
