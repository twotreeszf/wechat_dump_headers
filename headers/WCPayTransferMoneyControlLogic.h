...
@class JSEvent, MMTipsViewController, NSString, WCPayBizF2FTransferControlLogic, WCPayF2FMiddlePageSubLogic, WCPayF2FPayCheckCgi, WCPayPayMoneyLogic, WCPayTransferPayCheckCgi, WCPayTransferPrepayResponseStruct;
