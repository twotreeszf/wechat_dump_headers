...
@class MAVVideoComposition, NSMutableArray, NSString, UIPanGestureRecognizer, UIPinchGestureRecognizer, WCFinderEditVideoCropView, WCFinderEditVideoMultiVideoCropView, WCFinderEditVideoPorgressInfoViewModel, WCFinderEditVideoProgressInfoView, WCFinderHalfScreenEditFrameBlurView;
@protocol WCFinderVideoHalfScreenCompositionLayoutViewDelegate;

@interface WCFinderHalfScreenCompositionLayoutView : WCEditVideoLayoutView <WCFinderEditVideoProgressInfoViewDelegate, WCFinderEditVideoCropViewDelegate, WCEditImageOperationDelegate, WCFinderHalfScreenEditFrameBlurViewDelegate, WCFinderEditVideoMultiVideoCropViewDelegate>
{
    _Bool _isTimeCropDragging;
    _Bool _lastCropViewHeight;
    id <WCFinderVideoHalfScreenCompositionLayoutViewDelegate> _finderDelegate;
...
@property(nonatomic) __weak id <WCFinderVideoHalfScreenCompositionLayoutViewDelegate> finderDelegate; // @synthesize finderDelegate=_finderDelegate;
- (id)getMusicLogoName;
