...
@interface WAMsgNodeJSCoreCenter : MMUserService <IWAMsgNodeJSCoreDelegate, WAContactMgrExtension, WAMsgNodeLaunchLogicDelegate, IWAMsgNodeResourceMgrExt, MMServiceProtocol>
{
