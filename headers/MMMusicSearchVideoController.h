...
@protocol MMMusicSearchVideoControllerDelegate;

@interface MMMusicSearchVideoController : NSObject <UISearchBarDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MMMusicSearchVideoDataProviderDelegate>
{
