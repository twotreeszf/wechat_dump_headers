...
@class FTSWebSearchMgr, MMUIViewController, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIColor, UIImageView, UIScreenEdgePanGestureRecognizer, UISearchBar, UITextField, UIView, WCDataSearcher, WKWebSearchView, WSContactSearchLogic, WSJSEventHandler, WSResultViewLogic, WSSuggestionLogic, WSTagSearchLogic;
